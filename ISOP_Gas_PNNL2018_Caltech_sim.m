function[S]=ISOP_Gas_PNNL2018_Caltech_sim(test_dat,Do_GP)
...
if Do_GP
    savename=['C:\Users\tiann\Desktop\scy\Thornton_Matlab_Figures_Data\output\GP_PNNL2018Expt',...
        num2str(expt),'_Caltech.mat'];
else
    savename=['C:\Users\tiann\Desktop\scy\Thornton_Matlab_Figures_Data\output\Gas_PNNL2018Expt',...
        num2str(expt),'_Caltech.mat'];
end
%% METEOROLOGY
...
%     'LFlux'     'ExampleLightFlux.txt'; %Text file for radiation spectrum
    ...
    'EF_NO'     0  ;...  
    'J3'        2.2e-6;... % H2O2-OH+OH; Kroll state 0.00029/60,have used 0.00025/60 NOTE: 3.7e-6 s^-1 for Krechmer
    'J4'        0.006;... %was 0.29/60     %jvalue in Kroll seems too high (based on O3 production) Kroll 2006 %Override calcuated J-value for NO2 + hv -->
...
ChemFiles = {...gdx
    'F0AM_isop_K(Met)';
    'F0AM_isop_J(Met,0)'; %Jmethod flag of 1 specifies using "BottomUp" J-value method.
    'F0AM_isop_reactions'; %MCMv331 basic reactions
%     'Caltech_UNCCHAM' % MCMv331 UNCCAM
    };
% ParticleChemFiles= {'Isoprene_particle_chem_ucr2022_test'};
ParticleChemFiles= {'Isoprene_particle_chem_caltech'};
% ParticleChemFiles= {}; 
...
matfile='..\F0AM-WAM-2020-distribute\Tools\SMILES\UCR2022_isop_SpeciesInfo_v2.mat';
Vpfile = '..\F0AM-WAM-2020-distribute\Tools\SMILES\UCR2022_isop_VaporPressure_v2.xlsx'; %full path to the vapor pressure file
