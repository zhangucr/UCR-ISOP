function[S]=ISOP_Gas_PNNL2018_UCR_sim(test_dat,Do_GP)
...
if Do_GP
    savename=['.\output\GP_PNNL2018Expt',...
        num2str(expt),'_UCRv8.mat'];
else
    savename=['.\output\Gas_PNNL2018Expt',...
        num2str(expt),'_UCRv8.mat'];
end
%% METEOROLOGY
...
%     'LFlux'     'ExampleLightFlux.txt'; %Text file for radiation spectrum
    ...
    'JNO2_06'        0.006;... %was 0.29/60     %jvalue in Kroll seems too high (based on O3 production) Kroll 2006 %Override calcuated J-value for NO2 + hv -->
