...
'ICPDH';'IDHDP';'IDCHP';'ITHP';'ITHC';...% these species are the C5HOM, C5H10O5, C5H12O6, C5H8O5, C5H12O5, C5H10O4
'ICHNP';'IDHDN';'IDHPN';'IDHCN';'ICHDN';'ICDPN';'IHPDN';'IHNDP';'IHNDC';'ITHN';'INPA';'INCA';...% these species are the C5NHOM
...
k(:,i) = 0.1.*0.1*F0AM_isop_TUN(T,M,3.73E12,1.88E4,1.82E8); % this rate needs to be checked.
Gstr{i,1} = 'ISOPOOHOO'; 
...
%FZJ mechanism
% i=i+1;
% Rnames{i} = 'NISOPO2 + NO = NO2 + NIEPOXOO';
% k(:,i) =   F0AM_isop_ALK(T,M,2.7E-12,350.,2.76,9.,1.,0.);
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NO'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1; fNIEPOXOO(i)=fNIEPOXOO(i)+1;
% Caltech mechanism
% i=i+1;
...
% combined mechanism, assuming 50% of the beta-1-2-INO2 forms NIEPOXOO.
i=i+1;
Rnames{i} = 'NISOPO2 + NO = 0.537*NIT1 + 0.209*MVK + 0.046*MACR + 1.254*NO2 + 0.537*HO2 + 0.254*HCHO + 0.209*NIEPOXOO';
k(:,i) =   F0AM_isop_ALK(T,M,2.7E-12,350.,2.76,9.,1.,0.);
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NO'; 
fNISOPO2(i)=fNISOPO2(i)-1; fNO(i)=fNO(i)-1; fNIT1(i)=fNIT1(i)+0.537; fMVK(i)=fMVK(i)+0.209;
fMACR(i)=fMACR(i)+0.046;fNO2(i)=fNO2(i)+1.254;fHCHO(i)=fHCHO(i)+0.254;fHO2(i)=fHO2(i)+0.537;fNIEPOXOO(i)=fNIEPOXOO(i)+0.209;
...
% FZJ mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + HO2 = 0.633*NISOPOOH + 0.367*NIEPOXOO';
% k(:,i) =   2.06e-13.*exp(1300./ T);
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'HO2'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fHO2(i)=fHO2(i)-1; fNISOPOOH(i)=fNISOPOOH(i)+0.633; fNIEPOXOO(i)=fNIEPOXOO(i)+0.367;
% Caltech mechanism
% i=i+1;
...
% combined mechanism, assuming 50% of the beta-1-2-INO2 forms NIEPOXOO.
i=i+1;
Rnames{i} = ' NISOPO2 + HO2 = 0.756*NISOPOOH + 0.133*OH + 0.111*MVK + 0.023*MACR + 0.133*HCHO + 0.133*NO2 + 0.111*NIEPOXOO';
k(:,i) =   2.06e-13.*exp(1300./ T);
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'HO2';
fNISOPO2(i)=fNISOPO2(i)-1; fHO2(i)=fHO2(i)-1; fNISOPOOH(i)=fNISOPOOH(i)+0.756;fOH(i)=fOH(i)+0.133;
fMVK(i)=fMVK(i)+0.111;fMACR(i)=fMACR(i)+0.023;fHCHO(i)=fHCHO(i)+0.133;fNO2(i)=fNO2(i)+0.133;fNIEPOXOO(i)=fNIEPOXOO(i)+0.111;
...
% --------------IHDNOO-----------------
i=i+1;
Rnames{i} = 'IHDNOO + HO2 = 0.45*NO2 + 0.45*HCHO + 0.45*MVKN + 0.55*IHPDN';
k(:,i) = 2.6E-13*exp(1300./T);
Gstr{i,1} = 'IHDNOO'; Gstr{i,2} = 'HO2'; 
fIHDNOO(i)=fIHDNOO(i)-1; fHO2(i)=fHO2(i)-1;fNO2(i)=fNO2(i)+0.45;fHCHO(i)=fHCHO(i)+0.45;fMVKN(i)=fMVKN(i)+0.45;fIHPDN(i)=fIHPDN(i)+0.55;
% --------------NIEPOXOO-----------------
i=i+1;
...
% FZJ mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + MEO2 = 0.071*NIT1 + 0.193*ISOP1OH2N + 0.01*ISOP3N4OH + 0.061*ISOPHND + 0.664*NIEPOXOO + 0.5*HO2 + 0.75*HCHO + 0.25*MEOH ';
% k(:,i) =   7e-14; %1.3e-12; rate constant updated on 20230327 by HZ. The hydroxyl products (ISOP1N2OH, ISOP3OH4N) are isomers of ISOP1OH2N, ISOP3N4OH and hence lumped together.
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MEO2'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fMEO2(i)=fMEO2(i)-1; fNIT1(i)=fNIT1(i)+0.071; fISOP1OH2N(i)=fISOP1OH2N(i)+0.193; fISOP3N4OH(i)=fISOP3N4OH(i)+0.01;
% fISOPHND(i)=fISOPHND(i)+0.061; fNIEPOXOO(i)=fNIEPOXOO(i)+0.664; fHO2(i)=fHO2(i)+0.5; fHCHO(i)=fHCHO(i)+0.75; fMEOH(i)=fMEOH(i)+0.25;
% Caltech mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + MEO2 = 0.321*NO2 + 0.294*MVK + 0.027*MACR + 0.321*HCHO + 0.44*NIT1 + 0.428*HO2 + 0.242*ISOPHND +0.5*HCHO + 0.5*HO2 + 0.25*HCHO + 0.25*MEOH ';
% k(:,i) =   1.3e-12;
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MEO2'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fMEO2(i)=fMEO2(i)-1; fNO2(i)=fNO2(i)+0.321;fMVK(i)=fMVK(i)+0.294;fMACR(i)=fMACR(i)+0.027;
% fHCHO(i)=fHCHO(i)+1.071;fNIT1(i)=fNIT1(i)+0.437; fHO2(i)=fHO2(i)+0.928;fISOPHND(i)=fISOPHND(i)+0.242;fMEOH(i)=fMEOH(i)+0.25;
% combined mechanism, assuming 50% of the beta-1-2-INO2 forms NIEPOXOO.
i=i+1;
Rnames{i} = ' NISOPO2 + MEO2 = 0.025*NO2 + 0.024*MACR + 0.025*HCHO + 0.775*NIT1 + 0.767*HO2 + 0.200*ISOPHND + 0.5*HO2 + 0.75*HCHO + 0.25*MEOH ';
k(:,i) =   1.3e-12;
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MEO2'; 
fNISOPO2(i)=fNISOPO2(i)-1; fMEO2(i)=fMEO2(i)-1; fNO2(i)=fNO2(i)+0.025; fMACR(i)=fMACR(i)+0.024;
fHCHO(i)=fHCHO(i)+0.775;fNIT1(i)=fNIT1(i)+0.775; fHO2(i)=fHO2(i)+1.367; fISOPHND(i)=fISOPHND(i)+0.200; fMEOH(i)=fMEOH(i)+0.25;
...
% FZJ mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + NISOPO2 = 0.142*NIT1 + 0.386*ISOP1OH2N + 0.021*ISOP3N4OH + 0.122*ISOPHND + 1.329*NIEPOXOO';
% k(:,i) = 7e-14; %1.2e-12; rate constant updated on 20230327 by HZ.
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NISOPO2'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fNISOPO2(i)=fNISOPO2(i)-1; fNIT1(i)=fNIT1(i)+0.142; fISOP1OH2N(i)=fISOP1OH2N(i)+0.386; fISOP3N4OH(i)=fISOP3N4OH(i)+0.021;
% fISOPHND(i)=fISOPHND(i)+0.122; fNIEPOXOO(i)=fNIEPOXOO(i)+1.329;
% Caltech mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + NISOPO2 = 0.642*NO2 + 0.588*MVK + 0.054*MACR + 0.642*HCHO + 0.874*NIT1 + 0.856*HO2 + 0.484*ISOPHND';
% k(:,i) = 1.2e-12;
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NISOPO2'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fNISOPO2(i)=fNISOPO2(i)-1; fNO2(i)=fNO2(i)+0.642;fMVK(i)=fMVK(i)+0.588;fMACR(i)=fMACR(i)+0.054;
% fHCHO(i)=fHCHO(i)+0.642;fNIT1(i)=fNIT1(i)+0.874; fHO2(i)=fHO2(i)+0.856;fISOPHND(i)=fISOPHND(i)+0.484;
% combined mechanism, assuming 50% of the beta-1-2-INO2 forms NIEPOXOO.
i=i+1;
Rnames{i} = 'NISOPO2 + NISOPO2 = 0.049*NO2 + 0.001*MVK + 0.049*MACR + 0.049*HCHO + 1.550*NIT1 + 1.534*HO2 + 0.400*ISOPHND + 0.001*NIEPOXOO';
k(:,i) = KRO2RO2_HO.*0.95;
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NISOPO2'; 
fNISOPO2(i)=fNISOPO2(i)-2; fNO2(i)=fNO2(i)+0.025; fMVK(i)=fMVK(i)+0.001; fMACR(i)=fMACR(i)+0.049;
fHCHO(i)=fHCHO(i)+0.049;fNIT1(i)=fNIT1(i)+1.550; fHO2(i)=fHO2(i)+1.534; fISOPHND(i)=fISOPHND(i)+0.400;fNIEPOXOO(i)=fNIEPOXOO(i)+0.001;
...
% FZJ mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + RO2C = 0.071*NIT1 + 0.193*ISOP1OH2N + 0.01*ISOP3N4OH + 0.061*ISOPHND + 0.664*NIEPOXOO ';
% k(:,i) =  7e-14; %6.04e-12; rate constant updated on 20230327 by HZ.
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'RO2C'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fRO2C(i)=fRO2C(i)-1; fNIT1(i)=fNIT1(i)+0.071; fISOP1OH2N(i)=fISOP1OH2N(i)+0.193; fISOP3N4OH(i)=fISOP3N4OH(i)+0.01;
% fISOPHND(i)=fISOPHND(i)+0.061; fNIEPOXOO(i)=fNIEPOXOO(i)+0.664;
% Caltech mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + RO2C = 0.321*NO2 + 0.294*MVK + 0.027*MACR + 0.321*HCHO + 0.437*NIT1 + 0.428*HO2 + 0.242*ISOPHND ';
% k(:,i) =  6.04e-12;
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'RO2C'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fRO2C(i)=fRO2C(i)-1; fNO2(i)=fNO2(i)+0.321;fMVK(i)=fMVK(i)+0.294;fMACR(i)=fMACR(i)+0.027;
% fHCHO(i)=fHCHO(i)+0.321;fNIT1(i)=fNIT1(i)+0.437; fHO2(i)=fHO2(i)+0.428;fISOPHND(i)=fISOPHND(i)+0.242;
% combined mechanism, assuming 50% of the beta-1-2-INO2 forms NIEPOXOO.
i=i+1;
Rnames{i} = ' NISOPO2 + RO2C = 0.025*NO2 + 0.024*MACR + 0.025*HCHO + 0.775*NIT1 + 0.767*HO2 + 0.200*ISOPHND ';
k(:,i) =  7e-14; %6.04e-12; rate constant updated on 20230327 by HZ.
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'RO2C'; 
fNISOPO2(i)=fNISOPO2(i)-1; fRO2C(i)=fRO2C(i)-1; fNO2(i)=fNO2(i)+0.025; fMACR(i)=fMACR(i)+0.024;
fHCHO(i)=fHCHO(i)+0.025;fNIT1(i)=fNIT1(i)+0.775; fHO2(i)=fHO2(i)+0.767; fISOPHND(i)=fISOPHND(i)+0.200;
...
% FZJ mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + MECO3 = MEO2 + CO2 + 0.071*NIT1 + 0.193*ISOP1OH2N + 0.01*ISOP3N4OH + 0.061*ISOPHND + 0.664*NIEPOXOO';
% k(:,i) =  7e-14; %4.4e-13.*exp(1070./ T); rate constant updated on 20230327 by HZ.
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MECO3'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fMECO3(i)=fMECO3(i)-1; fNIT1(i)=fNIT1(i)+0.071; fISOP1OH2N(i)=fISOP1OH2N(i)+0.193; fISOP3N4OH(i)=fISOP3N4OH(i)+0.01;
% fISOPHND(i)=fISOPHND(i)+0.061; fNIEPOXOO(i)=fNIEPOXOO(i)+0.664; fMEO2(i)=fMEO2(i)+1;
% Caltech mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + MECO3 = MEO2 + CO2 + 0.321*NO2 + 0.294*MVK + 0.027*MACR + 0.321*HCHO + 0.437*NIT1 + 0.428*HO2 + 0.242*ISOPHND';
% k(:,i) =  4.4e-13.*exp(1070./ T);
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MECO3'; 
...
% combined mechanism, assuming 50% of the beta-1-2-INO2 forms NIEPOXOO.
i=i+1;
Rnames{i} = ' NISOPO2 + MECO3 = MEO2 + CO2 + 0.025*NO2 + 0.024*MACR + 0.025*HCHO + 0.775*NIT1 + 0.767*HO2 + 0.200*ISOPHND';
k(:,i) =  4.4e-13.*exp(1070./ T);
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MECO3'; 
fNISOPO2(i)=fNISOPO2(i)-1; fMECO3(i)=fMECO3(i)-1; fNO2(i)=fNO2(i)+0.025; fMACR(i)=fMACR(i)+0.024;
fHCHO(i)=fHCHO(i)+0.025;fNIT1(i)=fNIT1(i)+0.775; fHO2(i)=fHO2(i)+0.767; fISOPHND(i)=fISOPHND(i)+0.200; fMEO2(i)=fMEO2(i)+1;fCO2(i)=fCO2(i)+1;
...
%FZJ mechanism
% i=i+1;
% Rnames{i} = ' NISOPO2 + NO3 = NO2 + NIEPOXOO';
% k(:,i) =  5e-12; %2.3e-12;rate constant updated on 20230327 by HZ, based on Carlsson et al., 2023 ACP. 
% Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NO3'; 
% fNISOPO2(i)=fNISOPO2(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fNIEPOXOO(i)=fNIEPOXOO(i)+1;
%Caltech mechanism
% i=i+1;
...
% combined mechanism, assuming 50% of the beta-1-2-INO2 forms NIEPOXOO.
i=i+1;
Rnames{i} = ' NISOPO2 + NO3 = 1.254*NO2 + 0.209*MVK + 0.046*MACR + 0.254*HCHO + 0.537*NIT1 + 0.537*HO2 + 0.209*NIEPOXOO';
k(:,i) =  2.3e-12;
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NO3'; 
fNISOPO2(i)=fNISOPO2(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1.254;fMVK(i)=fMVK(i)+0.209;fMACR(i)=fMACR(i)+0.046;
fHCHO(i)=fHCHO(i)+0.254;fNIT1(i)=fNIT1(i)+0.537; fHO2(i)=fHO2(i)+0.537;fNIEPOXOO(i)=fNIEPOXOO(i)+0.209;
...
i=i+1;
Rnames{i} ='NIT1 + NO3 = 0.47*NIT1NO3OOA + 0.47*HNO3 + 0.53*IHDNOO';
k(:,i) =  3.15e-13.*exp(-448./ T);
Gstr{i,1} = 'NIT1'; Gstr{i,2} = 'NO3'; 
fNIT1(i)=fNIT1(i)-1; fNO3(i)=fNO3(i)-1; fNIT1NO3OOA(i)=fNIT1NO3OOA(i)+0.47; fHNO3(i)=fHNO3(i)+0.47; fIHDNOO(i)=fIHDNOO(i)+0.53;
