% SAPRC07tic_woisop.m
% manually converted by Xiaoyan Yang (UCR), based on the saprc07tic_ae7i_aq
...
'xCO'; 'xMECO3'; 'xHCHO'; 'MEK'; 'zRNO3'; 'xRCO3'; 'xRCHO'; 'HCOOH'; 'xMGLY'; 'xBACL'; ...
...
'RO2CRO2XC'; 'RO2XCHO2'; 'HO2MEO2'; 'RO2XCNO';'RCOOOH';'RCOOH';'HACET';'HCOCO3';'IMACO3';'MACROO';'MVKOO'; ...
'xHOCCHO';'HOCCHO';'ISOPRXN';'ISOPND';'HC5';'ARO2MN';'NISOPO2';'NIT1'; ...
'NISOPOOH';'BENZRO2';'SOAALK';'SVAVB2';'SVAVB3';'SVAVB4';'ACROLEIN';'CCOOOH';'CCOOH';'TOLRO2';'XYLRO2'; ...'xACROLEIN';
'PAHRO2';'NAPHTHAL';'TRPRXN';'zMTNO3';'TERPNRO2';'SESQ';'SESQRXN';'xACROLEIN';'RCHO';'PROPENE';'BUTADIENE13';'APIN'; ...
'TOLUENE';'MXYL';'OXYL';'PXYL';'TMBENZ124';'ETOH';'DD';'PROPNN';'MVKN';'ETHLN';'RNO3I';...
'MACRN';'NIT1NO3OOA';'NIT1OHOO';'IEPOXOO';'IMPAA';'IMAPAN';'IMAE';'IHMML';'HC5OO';'PYRUACD';
'MTNO3';'xMTNO3';'SVAVB1';...
% below are original SAPRC07 species that are removed in this mechanism
% 'ISOPO2';'ISOPNB';'ISOPOOH';'HPALD';'ISPOND';'DIBOO';'DHMOB';'IEPOX';'NIT1NO3OOB';'ISOPNOOB';'ISOPNOOD';'ISOPNN'; ...
...
'IDH';'IDC';'IDN';...
'ICHE';'IDHPE';'IDNE';'IHPE';'IHNE';'IPNE';'ICNE';...% epoxides other than IEPOX and MAE
'ICPDH';'IDHDP';'IDCHP';'ICTP';...% these 4 species are the C5HOM
'ICHNP';'IDHDN';'IDHPN';'IDHCN';'ICHDN';'ICDPN';'IHPDN';'IHNDP';'IHNDC';'ITHN';...% these species are the C5NHOM
'MACROOHOH';'MVKOOHOH';'HC4';'C4DH';'C4ENOL';'C4PN';...% MACR and MVK products
'HPETHNL';'HPAC';'MGA';'NMGA';
'ISOP1OHOO';'ISOP4OHOO';'ICDPOO';'ISOPOOHOO1';'ISOPOOHOO2';'ISOPOOHOO3';...
'ISOPNOO';'IHDNOO';'IHPNOO';...% RO2
'IEPOXOS';'TETROLS'; 'TETROLSp';
};
...
%BP20 name changed
i=i+1;
Rnames{i} = ' HCOOH + OH = 0.509*MEO2 + 0.491*RO2C + 0.509*CO2 + 0.491*xHO2 +  0.491*xMGLY + 0.491*yROOH + -0.491*XC ';
k(:,i) =  4.20e-14.*exp(855./ T);
Gstr{i,1} = 'HCOOH'; Gstr{i,2} = 'OH'; 
fHCOOH(i)=fHCOOH(i)-1; fOH(i)=fOH(i)-1; fMEO2(i)=fMEO2(i)+0.509; fRO2C(i)=fRO2C(i)+0.491; fCO2(i)=fCO2(i)+0.509; 
...
i=i+1;
Rnames{i} = ' IPRD + O3 = 0.285*OH + 0.4*HO2 + 0.048*RO2C + 0.048*xRCO3 + 0.498*CO + 0.14*CO2 + 0.124*HCHO + 0.21*MEK + 0.023*GLY + 0.742*MGLY + 0.1*HCOOH + 0.372*RCOOH + 0.047*xHOCCHO + 0.001*xHCHO + 0.048*yR6OOH + -0.329*XC';
k(:,i) =  4.18e-18;
...
fHCOOH(i)=fHCOOH(i)+0.1; fRCOOH(i)=fRCOOH(i)+0.372; fxHOCCHO(i)=fxHOCCHO(i)+0.047; fxHCHO(i)=fxHCHO(i)+0.001; fyR6OOH(i)=fyR6OOH(i)+0.048; fXC(i)=fXC(i)+-0.329; 
...
%BP76 new added
i=i+1;
Rnames{i} = ' ACROLEIN + O3 = 0.83*HO2 + 0.33*OH + 1.005*CO + 0.31*CO2 + 0.5*HCHO + 0.185*HCOOH + 0.5*GLY ';
...
%BE03
i=i+1;
Rnames{i} = ' ETHE + O3 = 0.16*OH + 0.16*HO2 + 0.51*CO + 0.12*CO2 + HCHO + 0.37*HCOOH';
k(:,i) =  9.14e-15.*exp(-2580./ T);
Gstr{i,1} = 'ETHE'; Gstr{i,2} = 'O3'; 
fETHE(i)=fETHE(i)-1; fO3(i)=fO3(i)-1; fOH(i)=fOH(i)+0.16; fHO2(i)=fHO2(i)+0.16; 
fCO(i)=fCO(i)+0.51; fCO2(i)=fCO2(i)+0.12; fHCHO(i)=fHCHO(i)+1; fHCOOH(i)=fHCOOH(i)+0.37; 
...
i=i+1;
Rnames{i} = ' ACETYLENE + OH = 0.7*OH + 0.3*HO2 + 0.3*CO + 0.7*GLY + 0.3*HCOOH';
k(:,i) = K_ACYE_OH;
Gstr{i,1} = 'ACETYLENE'; Gstr{i,2} = 'OH'; 
fACETYLENE(i)=fACETYLENE(i)-1; fOH(i)=fOH(i)-1; fOH(i)=fOH(i)+0.7; fHO2(i)=fHO2(i)+0.3; 
fCO(i)=fCO(i)+0.3; fGLY(i)=fGLY(i)+0.7; fHCOOH(i)=fHCOOH(i)+0.3;
...
%BL07
i=i+1;
Rnames{i} = ' OLE1 + O3 = 0.095*HO2 + 0.057*xHO2 + 0.128*OH + 0.09*RO2C + 0.005*RO2XC + 0.005*zRNO3 + 0.303*CO + 0.088*CO2 + 0.5*HCHO +0.011*xCCHO + 0.5*RCHO + 0.044*xRCHO + 0.003*xACET + 0.009*MEK +0.185*HCOOH + 0.159*RCOOH + 0.268*PRD2 + 0.011*yROOH + 0.052*yR6OOH +0.11*XC ';
...
fHCOOH(i)=fHCOOH(i)+0.185; fRCOOH(i)=fRCOOH(i)+0.159; 
...
% BL11
i=i+1;
Rnames{i} = ' OLE2 + O3 = 0.094*HO2 + 0.041*xHO2 + 0.443*OH + 0.307*MEO2 + 0.156*xMECO3 + 0.008*xRCO3 + 0.212*RO2C + 0.003*RO2XC + 0.003*zRNO3 +0.299*CO + 0.161*CO2 + 0.131*HCHO + 0.114*xHCHO + 0.453*CCHO + 0.071*xCCHO + 0.333*RCHO + 0.019*xRCHO + 0.051*ACET + 0.033*MEK +0.001*xMEK + 0.024*HCOOH + 0.065*CCOOH + 0.235*RCOOH + 0.037*PRD2 +0.073*yROOH + 0.136*yR6OOH + 0.16*XC';
...
fxMEK(i)=fxMEK(i)+0.001; fHCOOH(i)=fHCOOH(i)+0.024; fCCOOH(i)=fCCOOH(i)+0.065; fRCOOH(i)=fRCOOH(i)+0.235; 
...
%BL17
i=i+1;
Rnames{i} = ' TERP + O3 = 0.078*HO2 + 0.046*xHO2 + 0.499*OH + 0.202*xMECO3 +0.059*xRCO3 + 0.49*RO2C + 0.121*RO2XC + 0.121*zMTNO3 + 0.249*CO +0.063*CO2 + 0.127*HCHO + 0.033*xHCHO + 0.208*xRCHO + 0.057*xACET + 0.002*MEK + 0.172*HCOOH + 0.068*RCOOH + 0.003*xMGLY + 0.039*xBACL + 0.002*xMACR + 0.001*xIPRD + 0.502*PRD2 + 0.428*yR6OOH + TRPRXN + 3.852*XC';
...
fMEK(i)=fMEK(i)+0.002; fHCOOH(i)=fHCOOH(i)+0.172; fRCOOH(i)=fRCOOH(i)+0.068;
...
%BT20
i=i+1;
Rnames{i} = ' SESQ + O3 = 0.078*HO2 + 0.046*xHO2 + 0.499*OH + 0.202*xMECO3 + 0.059*xRCO3 + 0.49*RO2C + 0.121*RO2XC + 0.121*zRNO3 + 0.249*CO + 0.063*CO2 + 0.127*HCHO + 0.033*xHCHO + 0.208*xRCHO + 0.057*xACET + 0.002*MEK + 0.172*HCOOH + 0.068*RCOOH + 0.003*xMGLY + 0.039*xBACL + 0.002*xMACR + 0.001*xIPRD + 0.502*PRD2 + 0.428*yR6OOH + SESQRXN +  8.852*XC ';
k(:,i) =  8.28e-16.*exp(-785./ T);
...
fHCOOH(i)=fHCOOH(i)+0.172;fRCOOH(i)=fRCOOH(i)+0.068;
...
%BT02 new added
i=i+1;
Rnames{i} = 'PROPENE + O3 = 0.165*HO2 + 0.35*OH + 0.355*MEO2 + 0.525*CO + 0.215*CO2 + 0.5*HCHO + 0.5*CCHO + 0.185*HCOOH + 0.075*CCOOH + 0.07*XC';
...
fCO(i)=fCO(i)+0.525;fCO2(i)=fCO2(i)+0.215;fCCHO(i)=fCCHO(i)+0.5;fHCHO(i)=fHCHO(i)+0.5;fHCOOH(i)=fHCOOH(i)+0.185;
...
%BT06 new added
i=i+1;
Rnames{i} = 'BUTADIENE13 + O3 = 0.08*HO2 + 0.08*OH + 0.255*CO + 0.185*CO2 + 0.5*HCHO + 0.185*HCOOH + 0.5*ACROLEIN + 0.375*MVK + 0.125*PRD2 - 0.875*XC';
...
fCO2(i)=fCO2(i)+0.185;fHCHO(i)=fHCHO(i)+0.5;fHCOOH(i)=fHCOOH(i)+0.185;fACROLEIN(i)=fACROLEIN(i)+0.5;fMVK(i)=fMVK(i)+0.375;
...
%% Isoprene oxidation
%IS1. updated with the rxns below. 
% i=i+1;
...
i=i+1;
Rnames{i} = 'ISOP + OH = 0.15HPALD1 + 0.25HPALD2 + 0.4HO2 + 0.6ICDPOO';
k(:,i) = KISO1;
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'OH'; 
fISOP(i)=fISOP(i)-1; fOH(i)=fOH(i)-1; fHPALD1(i)=fHPALD1(i)+0.15; fHPALD2(i)=fHPALD2(i)+0.25; fHO2(i)=fHO2(i)+0.4; fICDPOO(i)=fICDPOO(i)+0.6; 
...
% i=i+1;
% Rnames{i} = ' ISOP + O3 = 0.266*OH + 0.066*HO2 + 0.192*RO2C + 0.008*RO2XC + 0.008*zRNO3 + 0.275*CO + 0.122*CO2 + 0.4*HCHO + 0.1*PRD2 + 0.39*MACR + 0.16*MVK + 0.15*IPRD + 0.204*HCOOH + 0.192*xMACO3 + 0.192*xHCHO +  0.2*yR6OOH + -0.559*XC ';
...
% fMACR(i)=fMACR(i)+0.39; fMVK(i)=fMVK(i)+0.16; fIPRD(i)=fIPRD(i)+0.15; fHCOOH(i)=fHCOOH(i)+0.204; 
...
i=i+1;
Rnames{i} = ' ISOP + O3 = 0.28*OH + 0.16*HO2 + 0.39*MACR + 0.16*MVK + 0.4*HCHO + 0.275*CO + 0.192*RO2C + 0.008*RO2XC + 0.008*zRNO3  + 0.122*CO2 + 0.1*PRD2 + 0.15*IPRD + 0.204*HCOOH + 0.192*xMACO3 + 0.192*xHCHO + 0.2*yR6OOH + -0.559*XC ';
k(:,i) =  7.86e-15.*exp(-1912./ T);
Gstr{i,1} = 'ISOP'; Gstr{i,2} = 'O3'; 
...
%BP55
i=i+1;
Rnames{i} = ' MACR + O3 = 0.208*OH + 0.108*HO2 + 0.1*RO2C + 0.45*CO + 0.117*CO2 + 0.1*HCHO + 0.9*MGLY + 0.333*HCOOH + 0.1*xRCO3 + 0.1*xHCHO + 0.1*yROOH +  -0.1*XC ';
k(:,i) =  1.40e-15.*exp(-2100./ T);
Gstr{i,1} = 'MACR'; Gstr{i,2} = 'O3'; 
fMACR(i)=fMACR(i)-1; fO3(i)=fO3(i)-1; fOH(i)=fOH(i)+0.208; fHO2(i)=fHO2(i)+0.108; fRO2C(i)=fRO2C(i)+0.1; fCO(i)=fCO(i)+0.45; fCO2(i)=fCO2(i)+0.117; fHCHO(i)=fHCHO(i)+0.1; fMGLY(i)=fMGLY(i)+0.9; fHCOOH(i)=fHCOOH(i)+0.333; fxRCO3(i)=fxRCO3(i)+0.1; fxHCHO(i)=fxHCHO(i)+0.1; fyROOH(i)=fyROOH(i)+0.1; fXC(i)=fXC(i)+-0.1; 
...
%BP60
i=i+1;
Rnames{i} = ' MVK + O3 = 0.164*OH + 0.064*HO2 + 0.05*RO2C + 0.05*xHO2 + 0.475*CO + 0.124*CO2 + 0.05*HCHO + 0.95*MGLY + 0.351*HCOOH + 0.05*xRCO3 + 0.05*xHCHO + 0.05*yROOH + -0.05*XC ';
k(:,i) =  8.50e-16.*exp(-1520./ T);
Gstr{i,1} = 'MVK'; Gstr{i,2} = 'O3'; 
fMVK(i)=fMVK(i)-1; fO3(i)=fO3(i)-1; fOH(i)=fOH(i)+0.164; fHO2(i)=fHO2(i)+0.064; fRO2C(i)=fRO2C(i)+0.05; fxHO2(i)=fxHO2(i)+0.05; fCO(i)=fCO(i)+0.475; fCO2(i)=fCO2(i)+0.124; fHCHO(i)=fHCHO(i)+0.05; fMGLY(i)=fMGLY(i)+0.95; fHCOOH(i)=fHCOOH(i)+0.351; fxRCO3(i)=fxRCO3(i)+0.05; fxHCHO(i)=fxHCHO(i)+0.05; fyROOH(i)=fyROOH(i)+0.05; fXC(i)=fXC(i)+-0.05; 
...
i=i+1;%1,6-H shift. Updated on 20220912 by HZ.
Rnames{i} = 'ISOP1OHOO = 0.15HPALD1 + 0.25HPALD2 + 0.4HO2 + 0.6ICDPOO';
k(:,i) = (T.*5.1242E-5-0.0128).*5.05E15.*exp(-12200./T).*exp(1E8./T.^3);
Gstr{i,1} = 'ISOP1OHOO'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1; fHPALD1(i)=fHPALD1(i)+0.15; fHPALD2(i)=fHPALD2(i)+0.25; fHO2(i)=fHO2(i)+0.4; fICDPOO(i)=fICDPOO(i)+0.6;
% --------------ISOP4OHOO-----------------
i=i+1;%1,5-H shift
...
i=i+1;%1,6-H shift
Rnames{i} = 'ISOP4OHOO = 0.15HPALD1 + 0.25HPALD2 + 0.4HO2 + 0.6ICDPOO';
k(:,i) = (T.*1.1346E-4-0.0306).*2.22E9.*exp(-7160./T).*exp(1E8./T.^3);
Gstr{i,1} = 'ISOP4OHOO'; 
fISOP4OHOO(i)=fISOP4OHOO(i)-1; fHPALD1(i)=fHPALD1(i)+0.15; fHPALD2(i)=fHPALD2(i)+0.25; fHO2(i)=fHO2(i)+0.4; fICDPOO(i)=fICDPOO(i)+0.6;
% --------------MACROO-----------------
%IA80. Unchanged.
i=i+1;
...
% below are new additional RO2 isomerization rxns. Updated on 20220913 by
% HZ
% --------------ISOPOOHOO-----------------
i=i+1;
...
i=i+1;
Rnames{i} = 'ISOPOOHOO2 = 0.32ICPDH + 0.68IDHPE + OH';
...
% --------------IEPOXOO-----------------
i=i+1;
Rnames{i} = 'IEPOXOO = IDCHP + HO2';
k(:,i) = 1.875E13*exp(-10000./T);
Gstr{i,1} = 'IEPOXOO';
fIEPOXOO(i)=fIEPOXOO(i)-1; fIDCHP(i)=fIDCHP(i)+1; fHO2(i)=fHO2(i)+1; 
i=i+1;
...
% --------------HC5OO-----------------
i=i+1;
Rnames{i} = 'HC5OO = HO2 + CO + CO + HACET + OH';
k(:,i) = 1.875E13*exp(-10000./T);
Gstr{i,1} = 'HC5OO'; 
fHC5OO(i)=fHC5OO(i)-1; fCO(i)=fCO(i)+2; fHO2(i)=fHO2(i)+1; fHACET(i)=fHACET(i)+1; fOH(i)=fOH(i)+1;
% --------------ICDPOO-----------------
i=i+1;
Rnames{i} = 'ICDPOO = 2OH + 1.425CO + 0.5MGLY + 0.5HCHO + 0.075MECO3 + 0.075HPETHNL + 0.425HPAC + 0.425HO2';
k(:,i) = F0AM_isop_TUN(T,M,4.33E12,1.00E4,1.14E8);
Gstr{i,1} = 'ICDPOO'; 
fICDPOO(i)=fICDPOO(i)-1; fOH(i)=fOH(i)+2;fCO(i)=fCO(i)+1.425;fMGLY(i)=fMGLY(i)+0.5;fHCHO(i)=fHCHO(i)+0.5;
fMECO3(i)=fMECO3(i)+0.075;fHPETHNL(i)=fHPETHNL(i)+0.075;fHPAC(i)=fHPAC(i)+0.425;fHO2(i)=fHO2(i)+0.425;
% --------------ISOPNOO-----------------
i=i+1;
Rnames{i} = 'ISOPNOO = ICHNP + HO2';
k(:,i) = 1.822E13.*exp(-10000./T); 
Gstr{i,1} = 'ISOPNOO'; 
fISOPNOO(i)=fISOPNOO(i)-1; fICHNP(i)=fICHNP(i)+1; fHO2(i)=fHO2(i)+1;
% --------------IHPNOO-----------------
i=i+1;
Rnames{i} = 'IHPNOO = ICHNP + OH';
k(:,i) = 6.55E12.*exp(-10000./T); 
Gstr{i,1} = 'IHPNOO'; 
fIHPNOO(i)=fIHPNOO(i)-1; fICHNP(i)=fICHNP(i)+1; fOH(i)=fOH(i)+1;
% --------------NIT1OHOO-----------------
i=i+1;
...
i=i+1;
Rnames{i} = 'ISOP1OHOO + NO = NO2 + 0.45HC5 + 0.45HO2 + 0.55MVKOOHOH + 0.55CO + 0.55OH';
k(:,i) = F0AM_isop_ALK(T,M,2.7E-12,350,1.421,6,-0.1644,-7.05E-4);
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'NO'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+0.45; fHC5(i)=fHC5(i)+0.45; fMVKOOHOH(i)=fMVKOOHOH(i)+0.55; fOH(i)=fOH(i)+0.55; fCO(i)=fCO(i)+0.55; 
% --------------ISOP4OHOO-----------------
i=i+1;
...
i=i+1;
Rnames{i} = 'ISOP4OHOO + NO = NO2 + 0.45HO2 + 0.45HC5 + 0.55MACROOHOH + 0.55CO + 0.55OH';
k(:,i) = F0AM_isop_ALK(T,M,2.7E-12,350,1.421,6,-0.2038,-9.04E-4);
Gstr{i,1} = 'ISOP4OHOO'; Gstr{i,2} = 'NO'; 
fISOP4OHOO(i)=fISOP4OHOO(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+0.45; fHC5(i)=fHC5(i)+0.45; fMACROOHOH(i)=fMACROOHOH(i)+0.55; fCO(i)=fCO(i)+0.55; fOH(i)=fOH(i)+0.55; 
...
i=i+1;
Rnames{i} = 'MACROO + NO = 0.86HACET + 0.86CO + 0.86HO2 + NO2 + 0.14MGLY + 0.14HCHO';
...
i=i+1;
Rnames{i} = 'IMACO3 + NO = 0.35MECO3 + 0.65MEO2 + 0.65CO + HCHO + CO2 + NO2';
...
i=i+1;
Rnames{i} = 'MVKOO + NO = 0.758MECO3 + 0.758HOCCHO + 0.242MGLY + 0.242HCHO + 0.242HO2 + NO2';
...
i=i+1;
Rnames{i} = ' NISOPO2 + NO = 0.535*NIT1 + 0.42*MVK + 0.045*MACR + 1.465*NO2 + 0.535*HO2 + 0.465*HCHO';
k(:,i) =   F0AM_isop_ALK(T,M,2.7E-12,350.,2.76,9.,1.,0.);
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NO'; 
fNISOPO2(i)=fNISOPO2(i)-1; fNO(i)=fNO(i)-1; fNIT1(i)=fNIT1(i)+0.535; fMVK(i)=fMVK(i)+0.42;
fMACR(i)=fMACR(i)+0.045;fNO2(i)=fNO2(i)+1.465;fHCHO(i)=fHCHO(i)+0.465;fHO2(i)=fHO2(i)+0.535;
...
% %IS18. updated with the rxns below, updated on 20220913 by HZ
% i=i+1;
...
i=i+1;
Rnames{i} = 'HC5OO + NO = IDHCN';
k(:,i) = F0AM_isop_NIT(T,M,2.7E-12,350,13.098,8,1,0);
Gstr{i,1} = 'HC5OO'; Gstr{i,2} = 'NO'; 
fHC5OO(i)=fHC5OO(i)-1; fNO(i)=fNO(i)-1; fIDHCN(i)=fIDHCN(i)+1; 
i=i+1;
Rnames{i} = 'HC5OO + NO = NO2 + 0.8HACET + 0.8CO + HCHO + HO2 + 0.2HC4';
k(:,i) = F0AM_isop_ALK(T,M,2.7E-12,350,13.098,8,1,0.);
Gstr{i,1} = 'HC5OO'; Gstr{i,2} = 'NO'; 
fHC5OO(i)=fHC5OO(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1; fHACET(i)=fHACET(i)+0.8; fCO(i)=fCO(i)+0.8; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHC4(i)=fHC4(i)+0.2; 

% %IS26. Removed.
% i=i+1;
% Rnames{i} = 'ISOPNOOD + NO = 0.34*PRD2 + 0.15*PROPNN + 0.44*HACET + 0.07*MVKN + 0.13*ETHLN + 0.31*HCOOH + 0.31*NO3 + 0.72*HCHO + 0.15*HOCCHO +  1.34*NO2 + 0.35*HO2 - 0.68*XC ';
...
% fHACET(i)=fHACET(i)+0.44;fMVKN(i)=fMVKN(i)+0.07;fETHLN(i)=fETHLN(i)+0.13;fHCOOH(i)=fHCOOH(i)+0.31;fNO3(i)=fNO3(i)+0.31;
...
% --------------ISOPNOO-----------------
i=i+1;
Rnames{i} = 'ISOPNOO + NO = 1.45NO2 + 0.55HO2 + 0.506HCHO + 0.468HOCCHO + 0.475HACET + 0.019PROPNN + 0.025ETHLN + 0.169MACRN + 0.337MVKN';
...
% i=i+1;
% Rnames{i} =' IEPOXOO + NO = 0.725*HACET + 0.275*HOCCHO + 0.275*GLY + 0.275*MGLY + 0.125*OH + 0.825*HO2 + 0.200*CO2 + 0.375*HCHO + 0.074*HCOOH + 0.251*CO + NO2';
% k(:,i) = 2.6e-12.*exp(380./ T);
...
% fHCOOH(i)=fHCOOH(i)+0.074;fCO(i)=fCO(i)+0.251;fNO2(i)=fNO2(i)+1;

i=i+1;
Rnames{i} = 'IEPOXOO + NO = NO2 + HO2 + 0.2CO + 0.2C4DH + 0.56HOCCHO + 0.56MGLY + 0.24GLY + 0.24HACET';
k(:,i) = F0AM_isop_ALK(T,M,2.7E-12,350,14.000,8,1,0);
Gstr{i,1} = 'IEPOXOO'; Gstr{i,2} = 'NO'; 
fIEPOXOO(i)=fIEPOXOO(i)-1; fNO(i)=fNO(i)-1; 
fC4DH(i)=fC4DH(i)+0.2; fHO2(i)=fHO2(i)+1; fNO2(i)=fNO2(i)+1; fCO(i)=fCO(i)+0.2; fHOCCHO(i)=fHOCCHO(i)+0.56; fMGLY(i)=fMGLY(i)+0.56; fGLY(i)=fGLY(i)+0.24; fHACET(i)=fHACET(i)+0.24; 
i=i+1;
Rnames{i} = 'IEPOXOO + NO = IDHCN';
k(:,i) =  F0AM_isop_NIT(T,M,2.7E-12,350,14.000,8,1,0);
Gstr{i,1} = 'IEPOXOO'; Gstr{i,2} = 'NO'; 
...
% --------------ISOPOOHOO-----------------
i=i+1;
Rnames{i} = 'ISOPOOHOO1 + NO = 0.17MACROOHOH + 0.17HCHO + 0.83HPETHNL + 0.83HACET + NO2 + HO2';
k(:,i) = F0AM_isop_ALK(T,M,2.7E-12,350,2.1,9,1,0);
Gstr{i,1} = 'ISOPOOHOO1'; Gstr{i,2} = 'NO'; 
fISOPOOHOO1(i)=fISOPOOHOO1(i)-1; fNO(i)=fNO(i)-1; fMACROOHOH(i)=fMACROOHOH(i)+0.17; fHCHO(i)=fHCHO(i)+0.17; fHPETHNL(i)=fHPETHNL(i)+0.83; fHACET(i)=fHACET(i)+0.83; fHO2(i)=fHO2(i)+1; fNO2(i)=fNO2(i)+1; 
i=i+1;
...
i=i+1;
Rnames{i} = 'ISOPOOHOO2 + NO = 0.847MVKOOHOH + 0.847HCHO + 0.153HOCCHO + 0.153HPAC + NO2 + HO2';
k(:,i) = F0AM_isop_ALK(T,M,2.7E-12,350,2.315,9,1,0);
Gstr{i,1} = 'ISOPOOHOO2'; Gstr{i,2} = 'NO'; 
fISOPOOHOO2(i)=fISOPOOHOO2(i)-1; fNO(i)=fNO(i)-1; fMVKOOHOH(i)=fMVKOOHOH(i)+0.847; fHCHO(i)=fHCHO(i)+0.847; fHOCCHO(i)=fHOCCHO(i)+0.153; fHPAC(i)=fHPAC(i)+0.153; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
i=i+1;
...
% --------------ICDPOO-----------------
i=i+1;
Rnames{i} = 'ICDPOO + NO = NO2 + OH + 0.2HCHO + 0.2HC4 + 0.12MGLY + 0.12HPETHNL + 0.68GLY + 0.68HPAC';
k(:,i) = F0AM_isop_ALK(T,M,2.7E-12,350,13.849,10,1,0);
Gstr{i,1} = 'ICDPOO'; Gstr{i,2} = 'NO'; 
fICDPOO(i)=fICDPOO(i)-1; fNO(i)=fNO(i)-1;
fNO2(i)=fNO2(i)+1;fOH(i)=fOH(i)+1;fHCHO(i)=fHCHO(i)+0.2;fHC4(i)=fHC4(i)+0.2;
fMGLY(i)=fMGLY(i)+0.12;fHPETHNL(i)=fHPETHNL(i)+0.12;fGLY(i)=fGLY(i)+0.68;fHPAC(i)=fHPAC(i)+0.68;
i=i+1;
Rnames{i} = 'ICDPOO + NO = ICDPN';
k(:,i) = F0AM_isop_NIT(T,M,2.7E-12,350,13.849,10,1,0);
Gstr{i,1} = 'ICDPOO'; Gstr{i,2} = 'NO'; 
fICDPOO(i)=fICDPOO(i)-1; fNO(i)=fNO(i)-1;fICDPN(i)=fICDPN(i)+1;
% --------------IHPNOO-----------------
i=i+1;
...
%% RO2 + HO2
% %IS3. updated with the rxns below.
% i=i+1;
...
% --------------ISOP1OHOO-----------------
i=i+1;
Rnames{i} = 'ISOP1OHOO + HO2 = 0.063MVK + 0.063OH + 0.063HO2 + 0.063HCHO + 0.937ISOPOOH12';
...
% --------------ISOP4OHOO-----------------
i=i+1;
Rnames{i} = 'ISOP4OHOO + HO2 = 0.063MACR + 0.063OH + 0.063HO2 + 0.063HCHO + 0.937ISOPOOH43';
...
i=i+1;
Rnames{i} = 'MACROO + HO2 = 0.41MACROOHOH + 0.51HACET + 0.51CO + 0.51HO2 + 0.59OH + 0.59O2 + 0.08MGLY + 0.08HCHO';
k(:,i) = 2.12E-13*exp(1300./T) ;
Gstr{i,1} = 'MACROO'; Gstr{i,2} = 'HO2'; 
fMACROO(i)=fMACROO(i)-1; fHO2(i)=fHO2(i)-0.49; fMACROOHOH(i)=fMACROOHOH(i)+0.41; fHACET(i)=fHACET(i)+0.51; fCO(i)=fCO(i)+0.51; fMGLY(i)=fMGLY(i)+0.08; fHCHO(i)=fHCHO(i)+0.08; fOH(i)=fOH(i)+0.59;
...
i=i+1;
Rnames{i} = 'IMACO3 + HO2 = 0.37IMPAA + 0.63HCHO + 0.325CO + 0.455MEO2 + 0.305MECO3 + 0.5CO2 + 0.5OH + 0.13O3';
...
i=i+1;
Rnames{i} = 'MVKOO + HO2 = 0.36MECO3 + 0.36HOCCHO + 0.665OH + 0.305HO2 + 0.255HC4 + 0.335MVKOOHOH + 0.05MGLY + 0.05HCHO';
k(:,i) = 2.12E-13*exp(1300./T); 
Gstr{i,1} = 'MVKOO'; Gstr{i,2} = 'HO2'; 
fMVKOO(i)=fMVKOO(i)-1; fHO2(i)=fHO2(i)-0.695; fMECO3(i)=fMECO3(i)+0.36; fHOCCHO(i)=fHOCCHO(i)+0.36; fOH(i)=fOH(i)+0.665; fHC4(i)=fHC4(i)+0.255; fMVKOOHOH(i)=fMVKOOHOH(i)+0.335; fMGLY(i)=fMGLY(i)+0.05; fHCHO(i)=fHCHO(i)+0.05; 
...
i=i+1;
Rnames{i} = ' NISOPO2 + HO2 = 0.755*NISOPOOH + 0.245*OH + 0.223*MVK + 0.023*MACR + 0.245*HCHO + 0.245*NO2';
k(:,i) =   2.06e-13.*exp(1300./ T);
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'HO2'; 
fNISOPO2(i)=fNISOPO2(i)-1; fHO2(i)=fHO2(i)-1; fNISOPOOH(i)=fNISOPOOH(i)+0.755;fOH(i)=fOH(i)+0.245;
fMVK(i)=fMVK(i)+0.223;fMACR(i)=fMACR(i)+0.023;fHCHO(i)=fHCHO(i)+0.245;fNO2(i)=fNO2(i)+0.245;

% %IS19. updated with the rxns below on 20220913
% i=i+1;
...
i=i+1;
Rnames{i} = 'HC5OO + HO2 = 0.35ICPDH + 0.65OH + 0.13HC4 + 0.65HCHO + 0.65HO2 + 0.52HACET + 0.52CO';
k(:,i) = 2.38E-13*exp(1300./T); 
Gstr{i,1} = 'HC5OO'; Gstr{i,2} = 'HO2'; 
fHC5OO(i)=fHC5OO(i)-1; fHO2(i)=fHO2(i)-0.35; fICPDH(i)=fICPDH(i)+0.35; fOH(i)=fOH(i)+0.65; fHC4(i)=fHC4(i)+0.13; fHCHO(i)=fHCHO(i)+0.65; fHACET(i)=fHACET(i)+0.52; fCO(i)=fCO(i)+0.52; 
...
i=i+1;
Rnames{i} = 'ISOPNOO + HO2 = 0.454IDHPN + 0.238HCHO + 0.546OH + 0.262HO2 + 0.283NO2 + 0.294HOCCHO + 0.297HACET + 0.011PROPNN + 0.013ETHLN + 0.037MACRN + 0.201MVKN';
k(:,i) = 2.6E-13*exp(1300./T); 
Gstr{i,1} = 'ISOPNOO'; Gstr{i,2} = 'HO2'; 
fISOPNOO(i)=fISOPNOO(i)-1; fHO2(i)=fHO2(i)-0.738; fIDHPN(i)=fIDHPN(i)+0.454; fHCHO(i)=fHCHO(i)+0.238; fOH(i)=fOH(i)+0.546; fNO2(i)=fNO2(i)+0.283;
fHOCCHO(i)=fHOCCHO(i)+0.294; fHACET(i)=fHACET(i)+0.297; fPROPNN(i)=fPROPNN(i)+0.011; fETHLN(i)=fETHLN(i)+0.013; fMACRN(i)=fMACRN(i)+0.037; fMVKN(i)=fMVKN(i)+0.201;
...
i=i+1;
Rnames{i} =' NIT1NO3OOA + HO2 = 0.375*RCOOOH + 0.125*RCOOH + 0.125*O3 + 0.5*XN + XC + 0.5*OH + 0.5*NO2 + 0.5*PROPNN + 0.5*CO + 0.5*HO2';
k(:,i) = 5.20e-13.*exp(980./ T);
Gstr{i,1} = 'NIT1NO3OOA'; Gstr{i,2} = 'HO2'; 
fNIT1NO3OOA(i)=fNIT1NO3OOA(i)-1; fHO2(i)=fHO2(i)-1; fRCOOOH(i)=fRCOOOH(i)+0.375;fXN(i)=fXN(i)+0.5;fXC(i)=fXC(i)+1;
fRCOOH(i)=fRCOOH(i)+0.125;fO3(i)=fO3(i)+0.125;fOH(i)=fOH(i)+0.5;fNO2(i)=fNO2(i)+0.5;fPROPNN(i)=fPROPNN(i)+0.5;fCO(i)=fCO(i)+0.5;fHO2(i)=fHO2(i)+0.5;
...
% i=i+1;
% Rnames{i} =' IEPOXOO + HO2 = 0.725*HACET + 0.275*HOCCHO + 0.275*GLY + 0.275*MGLY + 1.125*OH + 0.825*HO2 + 0.200*CO2 + 0.375*HCHO + 0.074*HCOOH + 0.251*CO ';
% k(:,i) = 2.06e-13.*exp(1300./ T);
...
% fHCOOH(i)=fHCOOH(i)+0.074;fCO(i)=fCO(i)+0.251;
i=i+1;
Rnames{i} = 'IEPOXOO + HO2 = 0.13CO + 0.65OH + 0.65HO2 + 0.13C4DH + 0.52HOCCHO + 0.364MGLY + 0.35ICPDH + 0.156HACET';
k(:,i) = 2.38E-13*exp(1300./T);
Gstr{i,1} = 'IEPOXOO'; Gstr{i,2} = 'HO2'; 
fIEPOXOO(i)=fIEPOXOO(i)-1; fHO2(i)=fHO2(i)-0.35; fCO(i)=fCO(i)+0.13;fOH(i)=fOH(i)+0.65;fICPDH(i)=fICPDH(i)+0.35;
fC4DH(i)=fC4DH(i)+0.13; fHOCCHO(i)=fHOCCHO(i)+0.52; fMGLY(i)=fMGLY(i)+0.364;fHACET(i)=fHACET(i)+0.156;

% below are new additional RO2 + HO2 rxns.
% --------------ISOPOOHOO-----------------
i=i+1;
Rnames{i} = 'ISOPOOHOO1 + HO2 = 0.59IDHDP + 0.032MACROOHOH + 0.032HCHO + 0.378HPETHNL + 0.378HACET + 0.41OH + 0.41HO2';
k(:,i) = 2.47E-13*exp(1300./T); 
Gstr{i,1} = 'ISOPOOHOO1'; Gstr{i,2} = 'HO2'; 
fISOPOOHOO1(i)=fISOPOOHOO1(i)-1; fHO2(i)=fHO2(i)-0.59; fIDHDP(i)=fIDHDP(i)+0.59; fMACROOHOH(i)=fMACROOHOH(i)+0.032; fOH(i)=fOH(i)+0.41; fHCHO(i)=fHCHO(i)+0.032; fHPETHNL(i)=fHPETHNL(i)+0.378; fHACET(i)=fHACET(i)+0.378; 
i=i+1;
Rnames{i} = 'ISOPOOHOO2 + HO2 = 0.76IDHDP + 0.17MVKOOHOH + 0.17HCHO + 0.07HOCCHO + 0.07HPAC + 0.24OH + 0.24HO2';
k(:,i) = 2.47E-13*exp(1300./T); 
Gstr{i,1} = 'ISOPOOHOO2'; Gstr{i,2} = 'HO2'; 
fISOPOOHOO2(i)=fISOPOOHOO2(i)-1; fHO2(i)=fHO2(i)-0.76; fIDHDP(i)=fIDHDP(i)+0.76; fMVKOOHOH(i)=fMVKOOHOH(i)+0.17; fHCHO(i)=fHCHO(i)+0.17; fHOCCHO(i)=fHOCCHO(i)+0.07; fHPAC(i)=fHPAC(i)+0.07; fOH(i)=fOH(i)+0.24; 
i=i+1;
Rnames{i} = 'ISOPOOHOO3 + HO2 = 0.35IDHDP + 0.65HOCCHO + 0.65HACET + 1.3OH';
k(:,i) = 2.47E-13*exp(1300./T); 
...
% --------------ICDPOO-----------------
i=i+1;
Rnames{i} = 'ICDPOO + HO2 = OH + 0.5ICTP + 0.3HC4 + 0.15HCHO + 0.15CO + 0.15HO2 + 0.03MGLY + 0.03HPETHNL + 0.17GLY + 0.17HPAC';
k(:,i) = 2.6E-13*exp(1300./T);
Gstr{i,1} = 'ICDPOO'; Gstr{i,2} = 'HO2'; 
fICDPOO(i)=fICDPOO(i)-1; fHO2(i)=fHO2(i)-1;
fOH(i)=fOH(i)+1;fICTP(i)=fICTP(i)+0.5;fHC4(i)=fHC4(i)+0.3;fHCHO(i)=fHCHO(i)+0.15;fCO(i)=fCO(i)+0.15;fHO2(i)=fHO2(i)+0.15;
fMGLY(i)=fMGLY(i)+0.03;fHPETHNL(i)=fHPETHNL(i)+0.03;fGLY(i)=fGLY(i)+0.17;fHPAC(i)=fHPAC(i)+0.17;
...
% --------------IHDNOO-----------------
i=i+1;
Rnames{i} = 'IHDNOO + HO2 = 0.5*NO2 + 0.5*HCHO + 0.5*MVKN + 0.5*IHPDN';
k(:,i) = 2.6E-13*exp(1300./T);
Gstr{i,1} = 'IHDNOO'; Gstr{i,2} = 'HO2'; 
fIHDNOO(i)=fIHDNOO(i)-1; fHO2(i)=fHO2(i)-1;
fNO2(i)=fNO2(i)+0.5;fHCHO(i)=fHCHO(i)+0.5;fMVKN(i)=fMVKN(i)+0.5;fIHPDN(i)=fIHPDN(i)+0.5;
%% RO2 + RO2
...
i=i+1;
Rnames{i} = 'ISOP1OHOO + MEO2 = 0.86HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MVKOOHOH + 0.1IDH + 0.75*HCHO + 0.25*MEOH';
k(:,i) = (T.*7.0485E-4-0.1644)*2E-12; 
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'MEO2'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1;fMEO2(i)=fMEO2(i)-1;fHO2(i)=fHO2(i)+0.86;fHC5(i)=fHC5(i)+0.46;fMVKOOHOH(i)=fMVKOOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;fIDH(i)=fIDH(i)+0.1;fHCHO(i)=fHCHO(i)+0.75;fMEOH(i)=fMEOH(i)+0.25;
i=i+1;
Rnames{i} = 'ISOP4OHOO + MEO2 = 0.8*MACR + 0.8*HO2 + 0.8*HCHO + 0.1*HC5 + 0.1*IDH + 0.5HO2 + 0.75HCHO + 0.25MEOH';
...
i=i+1;
Rnames{i} = 'ISOP4OHOO + MEO2 = 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MACROOHOH + 0.1IDH + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = (T.*9.0435E-4-0.2038)*2E-12; 
Gstr{i,1} = 'ISOP4OHOO'; Gstr{i,2} = 'MEO2';
fISOP4OHOO(i)=fISOP4OHOO(i)-1;fMEO2(i)=fMEO2(i)-1;fHO2(i)=fHO2(i)+0.86; fHC5(i)=fHC5(i)+0.46; fMACROOHOH(i)=fMACROOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;fIDH(i)=fIDH(i)+0.1;
...
k(:,i) = (1.1644-T.*7.0485E-4)*6.8e-13;
...
i=i+1;
Rnames{i} = 'ISOP1OHOO + RO2C = 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MVKOOHOH + 0.1IDH';
k(:,i) = (T.*7.0485E-4-0.1644)*6.8e-13; 
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'RO2C'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1;fRO2C(i)=fRO2C(i)-1;fHO2(i)=fHO2(i)+0.36;fHC5(i)=fHC5(i)+0.46;fMVKOOHOH(i)=fMVKOOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;fIDH(i)=fIDH(i)+0.1;
i=i+1;
Rnames{i} = 'ISOP4OHOO + RO2C = 0.8*MACR + 0.8*HO2 + 0.8*HCHO + 0.1*HC5 + 0.1*IDH';
k(:,i) = (1.2038-T.*9.0435E-4)*6.8e-13; 
...
i=i+1;
Rnames{i} = 'ISOP4OHOO + RO2C = 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MACROOHOH + 0.1IDH';
k(:,i) = (T.*9.0435E-4-0.2038)*6.8e-13;
Gstr{i,1} = 'ISOP4OHOO'; Gstr{i,2} = 'RO2C';
fISOP4OHOO(i)=fISOP4OHOO(i)-1;fRO2C(i)=fRO2C(i)-1;fHO2(i)=fHO2(i)+0.36; fHC5(i)=fHC5(i)+0.46; fMACROOHOH(i)=fMACROOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;fIDH(i)=fIDH(i)+0.1;
...
i=i+1;
Rnames{i} = 'ISOP1OHOO + ISOP1OHOO = 0.72HO2 + 0.92HC5 + 0.88CO + 0.88OH + 0.88MVKOOHOH + 0.2IDH';
k(:,i) = (T.*7.0485E-4-0.1644)*2.49E-12; 
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'ISOP1OHOO'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-2;fHO2(i)=fHO2(i)+0.72;fHC5(i)=fHC5(i)+0.92;fMVKOOHOH(i)=fMVKOOHOH(i)+0.88; fCO(i)=fCO(i)+0.88; fOH(i)=fOH(i)+0.88;fIDH(i)=fIDH(i)+0.2;
i=i+1;
...
i=i+1;
Rnames{i} = 'ISOP4OHOO + ISOP4OHOO = 0.72HO2 + 0.92HC5 + 0.88CO + 0.88OH + 0.88MACROOHOH + 0.2IDH';
k(:,i) = (T.*9.0435E-4-0.2038)*3.94E-12;
Gstr{i,1} = 'ISOP4OHOO'; Gstr{i,2} = 'ISOP4OHOO';
fISOP4OHOO(i)=fISOP4OHOO(i)-2;fHO2(i)=fHO2(i)+0.72; fHC5(i)=fHC5(i)+0.92; fMACROOHOH(i)=fMACROOHOH(i)+0.88; fCO(i)=fCO(i)+0.88; fOH(i)=fOH(i)+0.88;fIDH(i)=fIDH(i)+0.2;
i=i+1;
...
i=i+1;
Rnames{i} = 'ISOP1OHOO + ISOP4OHOO = 0.8*MVK + 0.8*HO2 + 0.8*HCHO + 0.2*IDH + 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MACROOHOH + 0.1IDH';
k(:,i) = (0.9606+T.*1.995E-4)/2*3.08E-12; 
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'ISOP4OHOO'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1;fISOP4OHOO(i)=fISOP4OHOO(i)-1;
fMVK(i)=fMVK(i)+0.8; fHCHO(i)=fHCHO(i)+0.8; fHO2(i)=fHO2(i)+1.16; fIDH(i)=fIDH(i)+0.3;fHC5(i)=fHC5(i)+0.46; fMACROOHOH(i)=fMACROOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;
i=i+1;
Rnames{i} = 'ISOP1OHOO + ISOP4OHOO = 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MVKOOHOH + 0.1IDH + 0.8*MACR + 0.8*HO2 + 0.8*HCHO + 0.1*HC5 + 0.1*IDH';
k(:,i) = (1.0394-T.*1.995E-4)/2*3.08E-12; 
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'ISOP4OHOO'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1;fISOP4OHOO(i)=fISOP4OHOO(i)-1;
fHO2(i)=fHO2(i)+1.16;fHC5(i)=fHC5(i)+0.56;fMVKOOHOH(i)=fMVKOOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;fIDH(i)=fIDH(i)+0.2;
fMACR(i)=fMACR(i)+0.8; fHCHO(i)=fHCHO(i)+0.8;
i=i+1;
Rnames{i} = 'ISOP1OHOO + ISOP4OHOO = 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MVKOOHOH + 0.1IDH + 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MACROOHOH + 0.1IDH';
k(:,i) = (T.*1.6092E-3-0.3682)/2*3.08E-12; 
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'ISOP4OHOO'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1;fISOP4OHOO(i)=fISOP4OHOO(i)-1;
fHO2(i)=fHO2(i)+0.72;fHC5(i)=fHC5(i)+0.92;fMVKOOHOH(i)=fMVKOOHOH(i)+0.44; fCO(i)=fCO(i)+0.88; fOH(i)=fOH(i)+0.88;fIDH(i)=fIDH(i)+0.2;fMACROOHOH(i)=fMACROOHOH(i)+0.44;
...
k(:,i) = (1.1644-T.*7.0485E-4)*4.4e-13.*exp(1070./ T);
...
i=i+1;
Rnames{i} = 'ISOP1OHOO + MECO3 = 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MVKOOHOH + 0.1IDH + MEO2 + CO2';
k(:,i) = (T.*7.0485E-4-0.1644)*4.4e-13.*exp(1070./ T); 
Gstr{i,1} = 'ISOP1OHOO'; Gstr{i,2} = 'MECO3'; 
fISOP1OHOO(i)=fISOP1OHOO(i)-1;fMECO3(i)=fMECO3(i)-1;fHO2(i)=fHO2(i)+0.36;fHC5(i)=fHC5(i)+0.46;fMVKOOHOH(i)=fMVKOOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;fIDH(i)=fIDH(i)+0.1;fMEO2(i)=fMEO2(i)+1;
i=i+1;
Rnames{i} = 'ISOP4OHOO + MECO3 = 0.8*MACR + 0.8*HO2 + 0.8*HCHO + 0.1*HC5 + 0.1*IDH + MEO2 + CO2';
k(:,i) = (1.2038-T.*9.0435E-4)*4.4e-13.*exp(1070./ T); 
...
i=i+1;
Rnames{i} = 'ISOP4OHOO + MECO3 = 0.36HO2 + 0.46HC5 + 0.44CO + 0.44OH + 0.44MACROOHOH + 0.1IDH + MEO2 + CO2';
k(:,i) = (T.*9.0435E-4-0.2038)*4.4e-13.*exp(1070./ T);
Gstr{i,1} = 'ISOP4OHOO'; Gstr{i,2} = 'MECO3';
fISOP4OHOO(i)=fISOP4OHOO(i)-1;fMECO3(i)=fMECO3(i)-1;fHO2(i)=fHO2(i)+0.36; fHC5(i)=fHC5(i)+0.46; fMACROOHOH(i)=fMACROOHOH(i)+0.44; fCO(i)=fCO(i)+0.44; fOH(i)=fOH(i)+0.44;fIDH(i)=fIDH(i)+0.1;fMEO2(i)=fMEO2(i)+1;
...
i=i+1;
Rnames{i} = 'MACROO + MEO2 = 0.6HACET + 0.6CO + 0.6HO2 + 0.1MGLY + 0.1HCHO + 0.3*C4DH + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-12;
Gstr{i,1} = 'MACROO'; Gstr{i,2} = 'MEO2'; 
...
% fXC(i)=fXC(i)-1;
i=i+1;
Rnames{i} = 'MACROO + RO2C = 0.6HACET + 0.6CO + 0.6HO2 + 0.1MGLY + 0.1HCHO + 0.3*C4DH';
k(:,i) = 2E-12;
Gstr{i,1} = 'MACROO'; Gstr{i,2} = 'RO2C'; 
...
% fCO(i)=fCO(i)+0.85;
i=i+1;
Rnames{i} = 'MACROO + MECO3 = 0.6HACET + 0.6CO + 0.6HO2 + 0.1MGLY + 0.1HCHO + 0.3*C4DH + MEO2 + CO2';
k(:,i) = 2E-12;
Gstr{i,1} = 'MACROO'; Gstr{i,2} = 'MECO3'; 
...
i=i+1;
Rnames{i} = 'IMACO3 + MEO2 = 0.545MECO3 + 0.755MEO2 + 0.455CO + HCHO + 0.7CO2 + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'MEO2'; 
...
% fHCHO(i)=fHCHO(i)+1;fMEO2(i)=fMEO2(i)+1;
i=i+1;
Rnames{i} = 'IMACO3 + RO2C = 0.545MECO3 + 0.755MEO2 + 0.455CO + HCHO + 0.7CO2';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'RO2C'; 
...
% fHCHO(i)=fHCHO(i)+1;fMEO2(i)=fMEO2(i)+1;
i=i+1;
Rnames{i} = 'IMACO3 + RO2XC = 0.545MECO3 + 0.755MEO2 + 0.455CO + HCHO + 0.7CO2';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'RO2XC'; 
...
i=i+1;
Rnames{i} = 'IMACO3 + MECO3 = 0.545MECO3 + 0.755MEO2 + 0.455CO + HCHO + 0.7CO2 + MEO2 + CO2';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'MECO3'; 
...
% fxCCHO(i)=fxCCHO(i)+1;
i=i+1;
Rnames{i} = 'IMACO3 + RCO3 = 0.545MECO3 + 0.755MEO2 + 0.455CO + HCHO + 0.7CO2 + RO2C + xHO2 + yROOH + xCCHO + CO2';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'RCO3'; 
...
i=i+1;
Rnames{i} = 'IMACO3 + BZCO3 = 0.545MECO3 + 0.755MEO2 + 0.455CO + HCHO + 0.7CO2 + BZO + RO2C + CO2';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'BZCO3'; 
...
i=i+1;
Rnames{i} = 'IMACO3 + MACO3 = 0.545MECO3 + 0.755MEO2 + 0.455CO + HCHO + 0.7CO2 + CO + CO2 + HCHO + MEO2';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'MACO3'; 
...
% fHCHO(i)=fHCHO(i)+2;fMEO2(i)=fMEO2(i)+2;
i=i+1;
Rnames{i} = 'IMACO3 + IMACO3 = 1.09MECO3 + 1.51MEO2 + 0.91CO + 2HCHO + 1.4CO2';
k(:,i) = 2E-12; 
Gstr{i,1} = 'IMACO3'; Gstr{i,2} = 'IMACO3'; 
...
i=i+1;
Rnames{i} = 'MVKOO + MEO2 = 0.455MECO3 + 0.455HOCCHO + 0.145MGLY + 0.145HCHO + 0.145HO2 + 0.2HC4 + 0.2*C4DH + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-12;
Gstr{i,1} = 'MVKOO'; Gstr{i,2} = 'MEO2'; 
fMVKOO(i)=fMVKOO(i)-1; fMEO2(i)=fMEO2(i)-1; fMECO3(i)=fMECO3(i)+0.455;fHOCCHO(i)=fHOCCHO(i)+0.455; fMGLY(i)=fMGLY(i)+0.145; fHCHO(i)=fHCHO(i)+0.895; fHO2(i)=fHO2(i)+0.645;fHC4(i)=fHC4(i)+0.2;fC4DH(i)=fC4DH(i)+0.2;fMEOH(i)=fMEOH(i)+0.25;
...
i=i+1;
Rnames{i} = 'MVKOO + RO2C = 0.455MECO3 + 0.455HOCCHO + 0.145MGLY + 0.145HCHO + 0.145HO2 + 0.2HC4 + 0.2*C4DH';
k(:,i) = 2E-12;
Gstr{i,1} = 'MVKOO'; Gstr{i,2} = 'RO2C'; 
fMVKOO(i)=fMVKOO(i)-1; fRO2C(i)=fRO2C(i)-1; fMECO3(i)=fMECO3(i)+0.455;fHOCCHO(i)=fHOCCHO(i)+0.455; fMGLY(i)=fMGLY(i)+0.145; fHCHO(i)=fHCHO(i)+0.145; fHO2(i)=fHO2(i)+0.145;fHC4(i)=fHC4(i)+0.2;fC4DH(i)=fC4DH(i)+0.2;
...
i=i+1;
Rnames{i} = 'MVKOO + MECO3 = 0.455MECO3 + 0.455HOCCHO + 0.145MGLY + 0.145HCHO + 0.145HO2 + 0.2HC4 + 0.2*C4DH + MEO2 + CO2';
k(:,i) = 2E-12;
Gstr{i,1} = 'MVKOO'; Gstr{i,2} = 'MECO3'; 
fMVKOO(i)=fMVKOO(i)-1; fMECO3(i)=fMECO3(i)-1; fMECO3(i)=fMECO3(i)+0.455;fHOCCHO(i)=fHOCCHO(i)+0.455; fMGLY(i)=fMGLY(i)+0.145; fHCHO(i)=fHCHO(i)+0.145; fHO2(i)=fHO2(i)+0.145;fHC4(i)=fHC4(i)+0.2;fC4DH(i)=fC4DH(i)+0.2;fMEO2(i)=fMEO2(i)+1;
...
% --------------NISOPO2-----------------
i=i+1;
Rnames{i} = ' NISOPO2 + MEO2 = 0.321*NO2 + 0.294*MVK + 0.027*MACR + 0.321*HCHO + 0.44*NIT1 + 0.428*HO2 + 0.242*ISOPND +0.5*HCHO + 0.5*HO2 + 0.25*HCHO + 0.25*MEOH ';
k(:,i) =   1.3e-12;
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MEO2'; 
fNISOPO2(i)=fNISOPO2(i)-1; fMEO2(i)=fMEO2(i)-1; fNO2(i)=fNO2(i)+0.321;fMVK(i)=fMVK(i)+0.294;fMACR(i)=fMACR(i)+0.027;
fHCHO(i)=fHCHO(i)+1.071;fNIT1(i)=fNIT1(i)+0.437; fHO2(i)=fHO2(i)+0.928;fISOPND(i)=fISOPND(i)+0.242;fMEOH(i)=fMEOH(i)+0.25;
...
i=i+1;
Rnames{i} = ' NISOPO2 + NISOPO2 = 0.642*NO2 + 0.588*MVK + 0.054*MACR + 0.642*HCHO + 0.874*NIT1 + 0.856*HO2 + 0.484*ISOPND';
k(:,i) = 1.2e-12;
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NISOPO2'; 
fNISOPO2(i)=fNISOPO2(i)-1; fNISOPO2(i)=fNISOPO2(i)-1; fNO2(i)=fNO2(i)+0.642;fMVK(i)=fMVK(i)+0.588;fMACR(i)=fMACR(i)+0.054;
fHCHO(i)=fHCHO(i)+0.642;fNIT1(i)=fNIT1(i)+0.874; fHO2(i)=fHO2(i)+0.856;fISOPND(i)=fISOPND(i)+0.484;
...
i=i+1;
Rnames{i} = ' NISOPO2 + RO2C = 0.321*NO2 + 0.294*MVK + 0.027*MACR + 0.321*HCHO + 0.437*NIT1 + 0.428*HO2 + 0.242*ISOPND ';
k(:,i) =  6.04e-12;
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'RO2C'; 
fNISOPO2(i)=fNISOPO2(i)-1; fRO2C(i)=fRO2C(i)-1; fNO2(i)=fNO2(i)+0.321;fMVK(i)=fMVK(i)+0.294;fMACR(i)=fMACR(i)+0.027;
fHCHO(i)=fHCHO(i)+0.321;fNIT1(i)=fNIT1(i)+0.437; fHO2(i)=fHO2(i)+0.428;fISOPND(i)=fISOPND(i)+0.242;
...
i=i+1;
Rnames{i} = ' NISOPO2 + MECO3 = MEO2 + CO2 + 0.321*NO2 + 0.294*MVK + 0.027*MACR + 0.321*HCHO + 0.437*NIT1 + 0.428*HO2 + 0.242*ISOPND';
k(:,i) =  4.4e-13.*exp(1070./ T);
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'MECO3'; 
fNISOPO2(i)=fNISOPO2(i)-1; fMECO3(i)=fMECO3(i)-1; fNO2(i)=fNO2(i)+0.321;fMVK(i)=fMVK(i)+0.294;fMACR(i)=fMACR(i)+0.027;
fHCHO(i)=fHCHO(i)+0.321;fNIT1(i)=fNIT1(i)+0.437; fHO2(i)=fHO2(i)+0.428;fISOPND(i)=fISOPND(i)+0.242;
fMEO2(i)=fMEO2(i)+1;fCO2(i)=fCO2(i)+1;

% %IS20. updated with the rxn below on 20220913
% i=i+1;
...
% fHCHO(i)=fHCHO(i)+0.75;fMEOH(i)=fMEOH(i)+0.25;
i=i+1;
Rnames{i} = 'HC5OO + MEO2 = 0.8HACET + 0.8CO + 1.75HCHO + 1.5HO2 + 0.2HC4 + 0.25MEOH';
k(:,i) =  2e-13;
Gstr{i,1} = 'HC5OO'; Gstr{i,2} = 'MEO2';
fHC5OO(i)=fHC5OO(i)-1; fMEO2(i)=fMEO2(i)-1; fHACET(i)=fHACET(i)+0.8; fCO(i)=fCO(i)+0.8; fHCHO(i)=fHCHO(i)+1.75; fHO2(i)=fHO2(i)+1.5; fHC4(i)=fHC4(i)+0.2; fMEOH(i)=fMEOH(i)+0.25;

% %IS21. updated with the rxn below on 20220913
% i=i+1;
...
i=i+1;
Rnames{i} = 'HC5OO + RO2C = 0.8HACET + 0.8CO + HCHO + HO2 + 0.2HC4';
k(:,i) =  3.5e-14;
Gstr{i,1} = 'HC5OO'; Gstr{i,2} = 'RO2C';
fHC5OO(i)=fHC5OO(i)-1; fRO2C(i)=fRO2C(i)-1; fHACET(i)=fHACET(i)+0.8; fCO(i)=fCO(i)+0.8; fHCHO(i)=fHCHO(i)+1.00; fHO2(i)=fHO2(i)+1.0; fHC4(i)=fHC4(i)+0.2;

% %IS22. updated with the rxn below on 20220913
% i=i+1;
...
i=i+1;
Rnames{i} = 'HC5OO + MECO3 = 0.8HACET + 0.8CO + HCHO + HO2 + 0.2HC4 + MEO2 + CO2';
k(:,i) =  4.4e-13.*exp(1070./ T);
Gstr{i,1} = 'HC5OO'; Gstr{i,2} = 'MECO3';
fHC5OO(i)=fHC5OO(i)-1; fMECO3(i)=fMECO3(i)-1; fHACET(i)=fHACET(i)+0.8; fCO(i)=fCO(i)+0.8; fHCHO(i)=fHCHO(i)+1.00; fHO2(i)=fHO2(i)+1.0; fHC4(i)=fHC4(i)+0.2; fMEO2(i)=fMEO2(i)+1.0;

% %IS142.Removed.
% i=i+1;
% Rnames{i} = 'ISOPNOOD + MEO2 = 0.17*PRD2 + 0.075*PROPNN + 0.22*HACET + 0.035*MVKN + 0.065*ETHLN + 0.155*HCOOH + 0.155*NO3 + 0.36*HCHO + 0.075*HOCCHO +  0.17*NO2 + 0.175*HO2 + 0.5*RNO3I + 0.25*HCHO + 0.25*MEOH + 0.5*HO2  + 0.5*HCHO - 0.84*XC ';
% k(:,i) =   2e-13;
...
% fHACET(i)=fHACET(i)+0.22;fMVKN(i)=fMVKN(i)+0.035;fETHLN(i)=fETHLN(i)+0.065;fHCOOH(i)=fHCOOH(i)+0.155;fNO3(i)=fNO3(i)+0.155;
...
% %IS143. Removed.
% i=i+1;
% Rnames{i} = 'ISOPNOOD + RO2C = 0.17*PRD2 + 0.075*PROPNN + 0.22*HACET + 0.035*MVKN + 0.065*ETHLN + 0.155*HCOOH + 0.155*NO3 + 0.36*HCHO + 0.075*HOCCHO + 0.17*NO2 + 0.175*HO2 + 0.5*RNO3I - 0.84*XC';
% k(:,i) =   3.5e-14;
...
% %IS144. Removed.
% i=i+1;
% Rnames{i} = 'ISOPNOOD + MECO3 = MEO2 + CO2 + 0.34*PRD2 + 0.15*PROPNN + 0.44*HACET + 0.07*MVKN + 0.13*ETHLN + 0.31*HCOOH + 0.31*NO3 + 0.72*HCHO +  0.15*HOCCHO + 0.34*NO2 + 0.35*HO2 - 0.68*XC';
% k(:,i) =   3.5e-14;
...
i=i+1;
Rnames{i} = 'ISOPNOO + MEO2 = 0.315NO2 + 0.385HO2 + 0.354HCHO + 0.328HOCCHO + 0.333HACET + 0.013PROPNN + 0.018ETHLN + 0.118MACRN + 0.236MVKN + 0.1IDHCN + 0.2ITHN + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-13;
...
% fXC(i)=fXC(i)-0.5;
i=i+1;
Rnames{i} = 'ISOPNOO + RO2C = 0.315NO2 + 0.385HO2 + 0.354HCHO + 0.328HOCCHO + 0.333HACET + 0.013PROPNN + 0.018ETHLN + 0.118MACRN + 0.236MVKN + 0.1IDHCN + 0.2ITHN';
k(:,i) = 3.5e-14;
...
% fCO2(i)=fCO2(i)+1;
i=i+1;
Rnames{i} = 'ISOPNOO + MECO3 = 0.315NO2 + 0.385HO2 + 0.354HCHO + 0.328HOCCHO + 0.333HACET + 0.013PROPNN + 0.018ETHLN + 0.118MACRN + 0.236MVKN + 0.1IDHCN + 0.2ITHN + MEO2 + CO2';
k(:,i) = 4.4e-13.*exp(1070./ T);
...
%IS38. Unchanged.
i=i+1;
Rnames{i} =' NIT1NO3OOA + RO2C = PROPNN + CO + CO2 + HO2 ';
k(:,i) =  4.40e-13.*exp(1070./ T);
Gstr{i,1} = 'NIT1NO3OOA'; Gstr{i,2} = 'RO2C'; 
fNIT1NO3OOA(i)=fNIT1NO3OOA(i)-1; fRO2C(i)=fRO2C(i)-1;fPROPNN(i)=fPROPNN(i)+1;fCO(i)=fCO(i)+1;
fCO2(i)=fCO2(i)+1;fHO2(i)=fHO2(i)+1;

%IS40. Unchanged.
i=i+1;
Rnames{i} =' NIT1NO3OOA + MEO2 =  PROPNN + CO + CO2 + HO2 + HCHO + HO2 ';
k(:,i) =  2.00e-12.*exp(500./ T);
Gstr{i,1} = 'NIT1NO3OOA'; Gstr{i,2} = 'MEO2'; 
fNIT1NO3OOA(i)=fNIT1NO3OOA(i)-1; fMEO2(i)=fMEO2(i)-1;fPROPNN(i)=fPROPNN(i)+1;fCO(i)=fCO(i)+1;
fCO2(i)=fCO2(i)+1;fHO2(i)=fHO2(i)+2;fHCHO(i)=fHCHO(i)+1;

%IS41. Unchanged.
i=i+1;
Rnames{i} =' NIT1NO3OOA + MECO3 = MEO2 + CO2 + PROPNN + CO + CO2 + HO2';
k(:,i) =  2.90e-12.*exp(500./ T);
Gstr{i,1} = 'NIT1NO3OOA'; Gstr{i,2} = 'MECO3'; 
fNIT1NO3OOA(i)=fNIT1NO3OOA(i)-1; fMECO3(i)=fMECO3(i)-1;fPROPNN(i)=fPROPNN(i)+1;fCO(i)=fCO(i)+1;
fCO2(i)=fCO2(i)+2;fHO2(i)=fHO2(i)+1;fMEO2(i)=fMEO2(i)+1;
...
% i=i+1;
% Rnames{i} =' IEPOXOO + MEO2 = 0.363*HACET + 0.138*HOCCHO + 0.138*GLY + 0.138*MGLY + 0.063*OH + 0.413*HO2 + 0.100*CO2 + 0.188*HCHO + 0.037*HCOOH + 0.126*CO + 0.5*PRD2 + 0.5*HCHO + 0.5*HO2 + 0.25*HCHO + 0.25*MEOH - 0.5*XC';
% k(:,i) = 2e-13;
...
% fHCOOH(i)=fHCOOH(i)+0.037;fCO(i)=fCO(i)+0.126;fPRD2(i)=fPRD2(i)+0.5;fHCHO(i)=fHCHO(i)+0.5;fHO2(i)=fHO2(i)+0.5;
% fHCHO(i)=fHCHO(i)+0.25;fMEOH(i)=fMEOH(i)+0.25;fXC(i)=fXC(i)-0.5;
i=i+1;
Rnames{i} = 'IEPOXOO + MEO2 = 0.2C4DH + 0.2CO + 0.6HOCCHO + 0.6MGLY)+ 0.2GLY + 0.2HACET + HO2 + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-13;
Gstr{i,1} = 'IEPOXOO'; Gstr{i,2} = 'MEO2'; 
fIEPOXOO(i)=fIEPOXOO(i)-1;fMEO2(i)=fMEO2(i)-1; fHCHO(i)=fHCHO(i)+0.75;fMEOH(i)=fMEOH(i)+0.25;
fC4DH(i)=fC4DH(i)+0.2;fCO(i)=fCO(i)+0.2;fHOCCHO(i)=fHOCCHO(i)+0.6;fMGLY(i)=fMGLY(i)+0.6;fGLY(i)=fGLY(i)+0.2;fHACET(i)=fHACET(i)+0.2;fHO2(i)=fHO2(i)+1.5;

% %IS113. updated with the rxns below.
% i=i+1;
% Rnames{i} =' IEPOXOO + RO2C = 0.363*HACET + 0.138*HOCCHO + 0.138*GLY + 0.138*MGLY + 0.063*OH + 0.413*HO2 + 0.100*CO2 + 0.188*HCHO + 0.037*HCOOH + 0.126*CO + 0.5*PRD2 - 0.5*XC';
% k(:,i) = 3.5e-14;
...
% fMGLY(i)=fMGLY(i)+0.138;fOH(i)=fOH(i)+0.063;fHO2(i)=fHO2(i)+0.413;fCO2(i)=fCO2(i)+0.1;fHCHO(i)=fHCHO(i)+0.188;
% fHCOOH(i)=fHCOOH(i)+0.037;fCO(i)=fCO(i)+0.126;fPRD2(i)=fPRD2(i)+0.5;fXC(i)=fXC(i)-0.5;
i=i+1;
Rnames{i} = 'IEPOXOO + RO2C = 0.2C4DH + 0.2CO + 0.6HOCCHO + 0.6MGLY)+ 0.2GLY + 0.2HACET + HO2';
k(:,i) = 3.5e-14;
Gstr{i,1} = 'IEPOXOO'; Gstr{i,2} = 'RO2C'; 
fIEPOXOO(i)=fIEPOXOO(i)-1;fRO2C(i)=fRO2C(i)-1; 
fC4DH(i)=fC4DH(i)+0.2;fCO(i)=fCO(i)+0.2;fHOCCHO(i)=fHOCCHO(i)+0.6;fMGLY(i)=fMGLY(i)+0.6;fGLY(i)=fGLY(i)+0.2;fHACET(i)=fHACET(i)+0.2;fHO2(i)=fHO2(i)+1;

% %IS114. updated with the rxns below.
% i=i+1;
% Rnames{i} =' IEPOXOO + MECO3 = 0.725*HACET + 0.275*HOCCHO + 0.275*GLY + 0.275*MGLY + 0.125*OH + 0.825*HO2 + 0.200*CO2 + 0.375*HCHO + 0.074*HCOOH + 0.251*CO + MEO2 + CO2';
% k(:,i) = 4.4e-13.*exp(1070./ T);
...
% fMGLY(i)=fMGLY(i)+0.275;fOH(i)=fOH(i)+0.125;fHO2(i)=fHO2(i)+0.825;fCO2(i)=fCO2(i)+0.2;fHCHO(i)=fHCHO(i)+0.375;
% fHCOOH(i)=fHCOOH(i)+0.074;fCO(i)=fCO(i)+0.251;fMEO2(i)=fMEO2(i)+1;fCO2(i)=fCO2(i)+1;
i=i+1;
Rnames{i} = 'IEPOXOO + MECO3 = 0.2C4DH + 0.2CO + 0.6HOCCHO + 0.6MGLY)+ 0.2GLY + 0.2HACET + HO2 + MEO2 + CO2';
k(:,i) = 4.4e-13.*exp(1070./ T);
Gstr{i,1} = 'IEPOXOO'; Gstr{i,2} = 'MECO3'; 
fIEPOXOO(i)=fIEPOXOO(i)-1;fMECO3(i)=fMECO3(i)-1; 
fC4DH(i)=fC4DH(i)+0.2;fCO(i)=fCO(i)+0.2;fHOCCHO(i)=fHOCCHO(i)+0.6;fMGLY(i)=fMGLY(i)+0.6;fGLY(i)=fGLY(i)+0.2;fHACET(i)=fHACET(i)+0.2;fHO2(i)=fHO2(i)+1;fMEO2(i)=fMEO2(i)+1;

% below are new additional RO2 + RO2 rxns. Updated on 20220913 by HZ.
% --------------ISOPOOHOO-----------------
i=i+1;
Rnames{i} = 'ISOPOOHOO1 + RO2C = 0.17MACROOHOH + 0.17HCHO + 0.83HPETHNL + 0.83HACET + HO2';
k(:,i) = 3.5e-14;
Gstr{i,1} = 'ISOPOOHOO1'; Gstr{i,2} = 'RO2C'; 
fISOPOOHOO1(i)=fISOPOOHOO1(i)-1; fRO2C(i)=fRO2C(i)-1; 
fMACROOHOH(i)=fMACROOHOH(i)+0.17; fHCHO(i)=fHCHO(i)+0.17; fHPETHNL(i)=fHPETHNL(i)+0.83; fHACET(i)=fHACET(i)+0.83; fHO2(i)=fHO2(i)+1;
i=i+1;
Rnames{i} = 'ISOPOOHOO1 + MEO2 = 0.17MACROOHOH + 0.17HCHO + 0.83HPETHNL + 0.83HACET + HO2 + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-13;
Gstr{i,1} = 'ISOPOOHOO1'; Gstr{i,2} = 'MEO2'; 
fISOPOOHOO1(i)=fISOPOOHOO1(i)-1; fMEO2(i)=fMEO2(i)-1; fMEOH(i)=fMEOH(i)+0.25;
fMACROOHOH(i)=fMACROOHOH(i)+0.17; fHCHO(i)=fHCHO(i)+0.93; fHPETHNL(i)=fHPETHNL(i)+0.83; fHACET(i)=fHACET(i)+0.83; fHO2(i)=fHO2(i)+1.5;
i=i+1;
Rnames{i} = 'ISOPOOHOO1 + MECO3 =  0.17MACROOHOH + 0.17HCHO + 0.83HPETHNL + 0.83HACET + HO2 + MEO2 + CO2';
k(:,i) = 4.4e-13.*exp(1070./ T);
Gstr{i,1} = 'ISOPOOHOO1'; Gstr{i,2} = 'MECO3'; 
fISOPOOHOO1(i)=fISOPOOHOO1(i)-1; fMECO3(i)=fMECO3(i)-1; 
fMACROOHOH(i)=fMACROOHOH(i)+0.17; fHCHO(i)=fHCHO(i)+0.17; fHPETHNL(i)=fHPETHNL(i)+0.83; fHACET(i)=fHACET(i)+0.83; fHO2(i)=fHO2(i)+1; fMEO2(i)=fMEO2(i)+1;

i=i+1;
Rnames{i} = 'ISOPOOHOO2 + RO2C = 0.847MVKOOHOH + 0.847HCHO + 0.153HOCCHO + 0.153HPAC + HO2';
k(:,i) = 3.5e-14;
Gstr{i,1} = 'ISOPOOHOO2'; Gstr{i,2} = 'RO2C'; 
fISOPOOHOO2(i)=fISOPOOHOO2(i)-1; fRO2C(i)=fRO2C(i)-1; 
fMVKOOHOH(i)=fMVKOOHOH(i)+0.847; fHCHO(i)=fHCHO(i)+0.847; fHOCCHO(i)=fHOCCHO(i)+0.153; fHPAC(i)=fHPAC(i)+0.153; fHO2(i)=fHO2(i)+1;
i=i+1;
Rnames{i} = 'ISOPOOHOO2 + MEO2 = 0.847MVKOOHOH + 0.847HCHO + 0.153HOCCHO + 0.153HPAC + HO2 + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-13;
Gstr{i,1} = 'ISOPOOHOO2'; Gstr{i,2} = 'MEO2'; 
fISOPOOHOO2(i)=fISOPOOHOO2(i)-1; fMEO2(i)=fMEO2(i)-1; fMEOH(i)=fMEOH(i)+0.25;
fMVKOOHOH(i)=fMVKOOHOH(i)+0.847; fHCHO(i)=fHCHO(i)+1.597; fHOCCHO(i)=fHOCCHO(i)+0.153; fHPAC(i)=fHPAC(i)+0.153; fHO2(i)=fHO2(i)+1.5;
i=i+1;
Rnames{i} = 'ISOPOOHOO2 + MECO3 = 0.847MVKOOHOH + 0.847HCHO + 0.153HOCCHO + 0.153HPAC + HO2 + MEO2 + CO2';
k(:,i) = 4.4e-13.*exp(1070./ T);
Gstr{i,1} = 'ISOPOOHOO2'; Gstr{i,2} = 'MECO3'; 
fISOPOOHOO2(i)=fISOPOOHOO2(i)-1; fMECO3(i)=fMECO3(i)-1; 
fMVKOOHOH(i)=fMVKOOHOH(i)+0.847; fHCHO(i)=fHCHO(i)+1.597; fHOCCHO(i)=fHOCCHO(i)+0.153; fHPAC(i)=fHPAC(i)+0.153; fHO2(i)=fHO2(i)+1.5; fMEO2(i)=fMEO2(i)+1;
...
i=i+1;
Rnames{i} = 'ISOPOOHOO3 + MEO2 = HOCCHO + HACET + OH + 0.5HO2 + 0.75HCHO + 0.25MEOH';
k(:,i) = 2E-13;
...
i=i+1;
Rnames{i} = ' NISOPO2 + NO3 = 1.47*NO2 + 0.42*MVK + 0.05*MACR + 0.47*HCHO + 0.54*NIT1 + 0.54*HO2';
k(:,i) =  2.3e-12;
Gstr{i,1} = 'NISOPO2'; Gstr{i,2} = 'NO3'; 
fNISOPO2(i)=fNISOPO2(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1.47;fMVK(i)=fMVK(i)+0.42;fMACR(i)=fMACR(i)+0.05;
fHCHO(i)=fHCHO(i)+0.47;fNIT1(i)=fNIT1(i)+0.54; fHO2(i)=fHO2(i)+0.54;
...
%% HPALD rxns
% %IS137. updated with the rxns below on 20220912.
% i=i+1;
...
i=i+1;
Rnames{i} = 'HPALD1 = CO + OH + HO2 + 0.15MVK + 0.85MACR';
k(:,i) = JHPALD;
Gstr{i,1} = 'HPALD1'; 
fHPALD1(i)=fHPALD1(i)-1; 
fCO(i)=fCO(i)+1; fOH(i)=fOH(i)+1; fHO2(i)=fHO2(i)+1; fMVK(i)=fMVK(i)+0.15; fMACR(i)=fMACR(i)+0.85;
i=i+1;
Rnames{i} = 'HPALD2 = CO + 1.64075OH + 0.1715HO2 + 0.46955C4ENOL + 0.1715IDC + 0.1715MGLY + 0.0336MVKOO + 0.1547MACROO + 0.1883RO2C';
k(:,i) = JHPALD;
Gstr{i,1} = 'HPALD2';
...
i=i+1;
Rnames{i} = 'HPALD1 + OH = OH + 0.2585*CO + 0.7415*ICHE + 0.0345*MVK + 0.119*MACR + 0.0285*MVKOOHOH +0.0765*MACROOHOH';
k(:,i) = 3.305E-11*exp(390./T); % proportioned by the two beta-HPALD isomer reactions.
Gstr{i,1} = 'HPALD1'; Gstr{i,2} = 'OH'; 
fHPALD1(i)=fHPALD1(i)-1;
fCO(i)=fCO(i)+0.2585; fICHE(i)=fICHE(i)+0.7415; fMVK(i)=fMVK(i)+0.0345; fMACR(i)=fMACR(i)+0.119; fMVKOOHOH(i)=fMVKOOHOH(i)+0.0285; fMACROOHOH(i)=fMACROOHOH(i)+0.0765;

i=i+1;
Rnames{i} = 'HPALD2 + OH = 0.375CO + 1.475OH + 0.16HO2 + 0.16HCHO + 0.16MGLY + 0.16ICHE + 0.0525MVK + 0.2975MACR + 0.15IDC + 0.0525MVKOOHOH + 0.1275MACROOHOH + 0.315RO2C  + 0.315CO2';
...
fMVKOOHOH(i)=fMVKOOHOH(i)+0.0525; fMACROOHOH(i)=fMACROOHOH(i)+0.1275; fRO2C(i)=fRO2C(i)+0.315;

%% ISOPOOH rxns
% %IS88 and IS89. updated with the rxns below on 20220912
% i=i+1;
...
% ISOPOOH + OH modified by HZ on 20220921 to bring the difference closer to
% Thornton, for better SOA simulations. 
i=i+1;
% Rnames{i} = 'ISOPOOH12 + OH = 0.72OH + 0.72IEPOXB + 0.079ISOPOOHOO3 + 0.041ISOPOOHOO1 + 0.12ISOP1OHOO + 0.02MVK + 0.02MVKOOHOH + 0.04HO2 + 0.04CO';
% The overall branching ratio of the three pathways changed to
% 0.71 (IEPOX):0.17(ISOPOOHOO):0.12(abstraction) based on Wennberg
Rnames{i} = 'ISOPOOH12 + OH = 0.71OH + 0.71IEPOXB + 0.111ISOPOOHOO3 + 0.059ISOPOOHOO1 + 0.09ISOP1OHOO + 0.015MVK + 0.015MVKOOHOH + 0.03HO2 + 0.03CO';
...
% fISOPOOH12(i)=fISOPOOH12(i)-1; fOH(i)=fOH(i)-0.28; fIEPOXB(i)=fIEPOXB(i)+0.72; fISOPOOHOO3(i)=fISOPOOHOO3(i)+0.079; fISOPOOHOO1(i)=fISOPOOHOO1(i)+0.041; fISOP1OHOO(i)=fISOP1OHOO(i)+0.12;fMVK(i)=fMVK(i)+0.02; fMVKOOHOH(i)=fMVKOOHOH(i)+0.02; fHO2(i)=fHO2(i)+0.04; fCO(i)=fCO(i)+0.04; 
fISOPOOH12(i)=fISOPOOH12(i)-1; fOH(i)=fOH(i)-0.29; fIEPOXB(i)=fIEPOXB(i)+0.71; fISOPOOHOO3(i)=fISOPOOHOO3(i)+0.111; fISOPOOHOO1(i)=fISOPOOHOO1(i)+0.059; fISOP1OHOO(i)=fISOP1OHOO(i)+0.09;fMVK(i)=fMVK(i)+0.015; fMVKOOHOH(i)=fMVKOOHOH(i)+0.015; fHO2(i)=fHO2(i)+0.03; fCO(i)=fCO(i)+0.03; 

i=i+1;
% Rnames{i} = 'ISOPOOH43 + OH = 0.81OH + 0.8IEPOXB + 0.092ISOPOOHOO3 + 0.048ISOPOOHOO2 + 0.031ISOP4OHOO + 0.01HC5 + 0.02CO + 0.02HO2 + 0.01MACR + 0.01MACROOHOH';
% The overall branching ratio of the three pathways changed to
% 0.79 (IEPOX):0.17(ISOPOOHOO):0.04(abstraction) based on Wennberg
Rnames{i} = 'ISOPOOH43 + OH = 0.81OH + 0.8IEPOXB + 0.092ISOPOOHOO3 + 0.048ISOPOOHOO2 + 0.031ISOP4OHOO + 0.01HC5 + 0.02CO + 0.02HO2 + 0.01MACR + 0.01MACROOHOH';
...
% fISOPOOH43(i)=fISOPOOH43(i)-1;fOH(i)=fOH(i)-0.19; fIEPOXB(i)=fIEPOXB(i)+0.8; fISOPOOHOO3(i)=fISOPOOHOO3(i)+0.092; fISOPOOHOO2(i)=fISOPOOHOO2(i)+0.048;fISOP4OHOO(i)=fISOP4OHOO(i)+0.031; fHC5(i)=fHC5(i)+0.01; fCO(i)=fCO(i)+0.02; fHO2(i)=fHO2(i)+0.02; fMACR(i)=fMACR(i)+0.01; fMACROOHOH(i)=fMACROOHOH(i)+0.01; 
fISOPOOH43(i)=fISOPOOH43(i)-1;fOH(i)=fOH(i)-0.204; fIEPOXB(i)=fIEPOXB(i)+0.79; fISOPOOHOO3(i)=fISOPOOHOO3(i)+0.111; fISOPOOHOO2(i)=fISOPOOHOO2(i)+0.059;fISOP4OHOO(i)=fISOP4OHOO(i)+0.020; fHC5(i)=fHC5(i)+0.006; fCO(i)=fCO(i)+0.013; fHO2(i)=fHO2(i)+0.013; fMACR(i)=fMACR(i)+0.007; fMACROOHOH(i)=fMACROOHOH(i)+0.007; 

i=i+1;
Rnames{i} = 'ISOPOOHD + OH = 0.38675ISOPOOHOO1 + 0.08925ISOPOOHOO2 + 0.0195ISOP1OHOO + 0.0105ISOP4OHOO + 0.374IEPOXD + 0.06HC5 + 0.524OH + 0.0303HO2 + 0.009HPALD1 + 0.015HPALD2 + 0.0423CO + 0.018HCHO + 0.018MGLY + 0.0117HPETHNL + 0.0117MECO3 + 0.0063HPAC';
...
i=i+1;
Rnames{i} = 'IEPOXD + OH = 0.75ICHE + 0.75HO2 + 0.25HC5OO';
k(:,i) = 3.22E-11*exp(-400./T);
Gstr{i,1} = 'IEPOXD'; Gstr{i,2} = 'OH'; 
fIEPOXD(i)=fIEPOXD(i)-1; fOH(i)=fOH(i)-1; fICHE(i)=fICHE(i)+0.75; fHO2(i)=fHO2(i)+0.75; fHC5OO(i)=fHC5OO(i)+0.25;
i=i+1;
...
i=i+1;
Rnames{i} = 'HC5 + OH = 0.5HC5OO + 0.5325OH + 0.16125HO2 + 0.1775MGLY + 0.33875CO + 0.1775CO2 + 0.04825MVKOOHOH + 0.113MACROOHOH + 0.16125IEPOXOO';
k(:,i) = 4.9E-11*exp(390./T); 
Gstr{i,1} = 'HC5'; Gstr{i,2} = 'OH';
fHC5(i)=fHC5(i)-1;fOH(i)=fOH(i)-0.4675; fHC5OO(i)=fHC5OO(i)+0.5; fHO2(i)=fHO2(i)+0.16125; fMGLY(i)=fMGLY(i)+0.1775; fCO(i)=fCO(i)+0.33875; fMVKOOHOH(i)=fMVKOOHOH(i)+0.04825; fMACROOHOH(i)=fMACROOHOH(i)+0.113; fIEPOXOO(i)=fIEPOXOO(i)+0.16125;
...
% %IS30
% i=i+1;
% Rnames{i} =' ISOPNB + O3 = 0.12*MVKN + 0.32*MACRN + 0.34*OH + 0.08*HO2 + 0.26*CO + 0.07*CO2 + 0.16*HCOOH + 0.56*HCHO + 0.28*RNO3I + 0.04*HACET + 0.28*NO2 + 0.24*BACL - 0.57*XC ';
% k(:,i) =  3.7e-19;
% Gstr{i,1} = 'ISOPNB'; Gstr{i,2} = 'O3'; 
% fISOPNB(i)=fISOPNB(i)-1; fO3(i)=fO3(i)-1; fHCHO(i)=fHCHO(i)+0.56;fOH(i)=fOH(i)+0.34;fCO(i)=fCO(i)+0.26;
% fHO2(i)=fHO2(i)+0.08;fMACRN(i)=fMACRN(i)+0.32;fMVKN(i)=fMVKN(i)+0.12;fNO2(i)=fNO2(i)+0.28;fHCOOH(i)=fHCOOH(i)+0.16;
...
i=i+1;
Rnames{i} = 'ISOP1OH2N + OH = 0.85ISOPNOO + 0.15IEPOXB + 0.15NO2';%two pathways combined. 0.85:0.15 based on rates.
...
i=i+1;
Rnames{i} = 'ISOP3N4OH + OH = 0.87*ISOPNOO + 0.13IEPOXB + 0.13NO2';
...
i=i+1;
Rnames{i} = 'ISOPHND = NO2 + 0.45HO2 + 0.3025MVKOOHOH + 0.2475MACROOHOH + 0.55CO + 0.55OH + 0.45HC5';
k(:,i) = JIC3ONO2; %J53 ; 
Gstr{i,1} = 'ISOPHND'; 
fISOPHND(i)=fISOPHND(i)-1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+0.45; fMVKOOHOH(i)=fMVKOOHOH(i)+0.3025; fMACROOHOH(i)=fMACROOHOH(i)+0.2475; fCO(i)=fCO(i)+0.55; fOH(i)=fOH(i)+0.55; fHC5(i)=fHC5(i)+0.45; 
i=i+1;
Rnames{i} = 'ISOPHND + OH = 0.9ISOPNOO + 0.057IEPOXD + 0.057NO2 + 0.044OH + 0.044CO + 0.044C4PN + 0.029HO2';
...
%% ISOPND rxns
% %IS25. updated with the rxns below on 20220915 by HZ.
% i=i+1;
...
i=i+1;
Rnames{i} = 'ISOPND + OH = 0.95ISOPNOO + 0.05ICHE';
k(:,i) =   1.2e-11.*exp(652./ T);
Gstr{i,1} = 'ISOPND'; Gstr{i,2} = 'OH'; 
fISOPND(i)=fISOPND(i)-1; fOH(i)=fOH(i)-1; fISOPNOO(i)=fISOPNOO(i)+0.95; fICHE(i)=fICHE(i)+0.05; 

%IS27. Unchanged.
i=i+1;
Rnames{i} = 'ISOPND + O3 = 0.36*ETHLN + 0.29*PROPNN + 0.70*MGLY + 0.12*RCOOH + 0.39*HO2 + 0.038*HCHO + 0.029*CO + 0.73*OH + 0.017*CO2 + 0.36*NO2 + 0.16*HACET + 0.34*HOCCHO - 0.26*XC ';
k(:,i) =  2.9e-17;
Gstr{i,1} = 'ISOPND'; Gstr{i,2} = 'O3'; 
fISOPND(i)=fISOPND(i)-1; fO3(i)=fO3(i)-1; fETHLN(i)=fETHLN(i)+0.36;fPROPNN(i)=fPROPNN(i)+0.29;fMGLY(i)=fMGLY(i)+0.7;
fRCOOH(i)=fRCOOH(i)+0.12;fHO2(i)=fHO2(i)+0.39;fHCHO(i)=fHCHO(i)+0.038;fCO(i)=fCO(i)+0.029;fOH(i)=fOH(i)+0.73;
fCO2(i)=fCO2(i)+0.017;fNO2(i)=fNO2(i)+0.36;fHACET(i)=fHACET(i)+0.16;fHOCCHO(i)=fHOCCHO(i)+0.34;fXC(i)=fXC(i)-0.26;

% new rxn for ISOPND + NO3. rate assumed to be the same as NIT1
i=i+1;
Rnames{i} = 'ISOPND + NO3 = 0.5*IHDNOO + 0.5*IDNE';
k(:,i) =  3.15e-13.*exp(-448./ T);
Gstr{i,1} = 'ISOPND'; Gstr{i,2} = 'NO3'; 
fISOPND(i)=fISOPND(i)-1; fNO3(i)=fNO3(i)-1; fIHDNOO(i)=fIHDNOO(i)+0.5;fIDNE(i)=fIDNE(i)+0.5;

%% NISOPOOH rxns
%IS99. updated with the rxns below.
% i=i+1;
...
i=i+1;
Rnames{i} = 'NISOPOOH + OH = 0.08*NISOPO2 + 0.09*NIT1 + 0.252*OH + 0.593*IHPNOO + 0.076*IHPE + 0.076*NO2 + 0.162*IHNE';
k(:,i) =  2.37e-11.*exp(390./ T); % rate constant based on the Caltech mechanism.
Gstr{i,1} = 'NISOPOOH'; Gstr{i,2} = 'OH'; 
fNISOPOOH(i)=fNISOPOOH(i)-1; fOH(i)=fOH(i)-1; fNISOPO2(i)=fNISOPO2(i)+0.08;fNIT1(i)=fNIT1(i)+0.09;fOH(i)=fOH(i)+0.252;
fIHPNOO(i)=fIHPNOO(i)+0.593;fIHPE(i)=fIHPE(i)+0.076;fNO2(i)=fNO2(i)+0.076;fIHNE(i)=fIHNE(i)+0.162;
...
k(:,i) =  2.9e-17; % rate constant based on ISOPND + O3.
...
i=i+1;
Rnames{i} = 'NISOPOOH + NO3 = IPNE';
k(:,i) =  3.15e-13.*exp(-448./ T); % rate constant based on ISOPND + NO3.
Gstr{i,1} = 'NISOPOOH'; Gstr{i,2} = 'NO3'; 
fNISOPOOH(i)=fNISOPOOH(i)-1; fNO3(i)=fNO3(i)-1; fIPNE(i)=fIPNE(i)+1;
%% IDN rxns
i=i+1;
...
i=i+1;
Rnames{i} = 'IDN = 0.1MVK + 0.01MACR + 0.11HCHO + 1.11NO2 + 0.455NIT1 + 0.455ISOPND + 0.455HO2';
k(:,i) = 2*JIC3ONO2; %J53 + J55 ; % SUN*5.0E-5;
Gstr{i,1} = 'IDN'; 
fIDN(i)=fIDN(i)-1; fMVK(i)=fMVK(i)+0.1; fMACR(i)=fMACR(i)+0.01; fHCHO(i)=fHCHO(i)+0.11; fNO2(i)=fNO2(i)+1.11; fNIT1(i)=fNIT1(i)+0.455; fISOPND(i)=fISOPND(i)+0.455; fHO2(i)=fHO2(i)+0.455; 
...
i=i+1;
Rnames{i} =' NIT1 + NO3 = 0.6*NIT1NO3OOA + 0.6*HNO3 + 0.348*C4PN + 0.4*NO2 + 0.052*ICNE + 0.348*CO';
k(:,i) =  3.15e-13.*exp(-448./ T);
Gstr{i,1} = 'NIT1'; Gstr{i,2} = 'NO3'; 
fNIT1(i)=fNIT1(i)-1; fNO3(i)=fNO3(i)-1; fNIT1NO3OOA(i)=fNIT1NO3OOA(i)+0.6;fHNO3(i)=fHNO3(i)+0.6;fC4PN(i)=fC4PN(i)+0.348;
fNO2(i)=fNO2(i)+0.4;fICNE(i)=fICNE(i)+0.052;fCO(i)=fCO(i)+0.348;
...
i=i+1;
Rnames{i} =' NIT1 + OH = 0.47*NIT1NO3OOA + 0.159*NIT1OHOO + 0.323*C4PN + 0.048*NO2 + 0.048*ICHE + 0.323*CO + 0.323*HO2';
k(:,i) = 7.48e-12.*exp(410./ T);
Gstr{i,1} = 'NIT1'; Gstr{i,2} = 'OH'; 
fNIT1(i)=fNIT1(i)-1; fOH(i)=fOH(i)-1;fNIT1NO3OOA(i)=fNIT1NO3OOA(i)+0.47;fNIT1OHOO(i)=fNIT1OHOO(i)+0.159;
fC4PN(i)=fC4PN(i)+0.323;fNO2(i)=fNO2(i)+0.048;fICHE(i)=fICHE(i)+0.048;fCO(i)=fCO(i)+0.323;fHO2(i)=fHO2(i)+0.323;
...
% --------------ICPDH-----------------
i=i+1;
Rnames{i} = 'ICPDH = 0.825OH + 1.175HO2 + 0.429CO + 0.254C4DH + 0.175MACROOHOH + 0.065HCHO + 0.065HC4 + 0.285HACET + 0.285GLY + 0.057HOCCHO + 0.057MGLY';
k(:,i) = JCOOH+JMEK_06; %J41 ;
% k(:,i) = 0.02.*JNO2_06; % added by chuanyang
Gstr{i,1} = 'ICPDH'; 
fICPDH(i)=fICPDH(i)-1; fOH(i)=fOH(i)+0.825; fHO2(i)=fHO2(i)+1.175; fCO(i)=fCO(i)+0.429; fC4DH(i)=fC4DH(i)+0.254; fMACROOHOH(i)=fMACROOHOH(i)+0.175; fHCHO(i)=fHCHO(i)+0.065; fHC4(i)=fHC4(i)+0.065; fHACET(i)=fHACET(i)+0.285; fGLY(i)=fGLY(i)+0.285; fHOCCHO(i)=fHOCCHO(i)+0.057; fMGLY(i)=fMGLY(i)+0.057;  
i=i+1;
Rnames{i} = 'ICPDH + OH = CO + 0.5HO2 + 0.5OH + 0.5MACROOHOH + 0.5C4DH';
k(:,i) = 1.0E-11 ;
Gstr{i,1} = 'ICPDH'; Gstr{i,2} = 'OH'; 
fICPDH(i)=fICPDH(i)-1; fOH(i)=fOH(i)-0.5; fCO(i)=fCO(i)+1; fHO2(i)=fHO2(i)+0.5; fMACROOHOH(i)=fMACROOHOH(i)+0.5; fC4DH(i)=fC4DH(i)+0.5;
% --------------IDHPE-----------------
i=i+1;
Rnames{i} = 'IDHPE = OH + HO2 + 0.429MGLY + 0.429HOCCHO + 0.571GLY + 0.571HACET';
k(:,i) = JCOOH; %J41 ;
% k(:,i) = 0.02.*JNO2_06; % added by chuanyang
Gstr{i,1} = 'IDHPE'; 
...
i=i+1;
Rnames{i} = 'IDHPE + OH = OH + CO2 + 0.571MACROOHOH + 0.429MVKOOHOH';
k(:,i) = 3.0E-12 ;
Gstr{i,1} = 'IDHPE'; Gstr{i,2} = 'OH'; 
fIDHPE(i)=fIDHPE(i)-1; fMACROOHOH(i)=fMACROOHOH(i)+0.571; fMVKOOHOH(i)=fMVKOOHOH(i)+0.429;
% --------------ICHE-----------------
i=i+1;
Rnames{i} = 'ICHE + OH = OH + 1.5CO + 0.5HCHO + 0.5MGLY + 0.5HACET';
...
% --------------IDHDP-----------------
i=i+1;
Rnames{i} = 'IDHDP = 1.25OH + 0.25HOCCHO + 0.25HACET + 0.75ICPDH + 0.75HO2';
k(:,i) = 2*JCOOH; %2*J41 ;
% k(:,i) = 0.02.*JNO2_06; % added by chuanyang
Gstr{i,1} = 'IDHDP';
...
% --------------IDCHP-----------------
i=i+1;
Rnames{i} = 'IDCHP = 0.546OH + 1.454CO + 1.454HO2 + 0.546HC4 + 0.454MGLY';
k(:,i) = 2*JMEK_06+JCOOH; %2*J22 + J41 ;
Gstr{i,1} = 'IDCHP'; 
fIDCHP(i)=fIDCHP(i)-1; fOH(i)=fOH(i)+0.546; fCO(i)=fCO(i)+1.454; fHO2(i)=fHO2(i)+1.454; fHC4(i)=fHC4(i)+0.546; fMGLY(i)=fMGLY(i)+0.454; 
i=i+1;
Rnames{i} = 'IDCHP + OH = 1.332CO + 0.444OH + 0.444HO2 + 0.444HC4 + 0.112IEPOXOO + 0.444MGLY';
k(:,i) = 2.25E-11 ;
Gstr{i,1} = 'IDCHP'; Gstr{i,2} = 'OH'; 
fIDCHP(i)=fIDCHP(i)-1; fOH(i)=fOH(i)-0.556; fCO(i)=fCO(i)+1.332; fHO2(i)=fHO2(i)+0.444; fHC4(i)=fHC4(i)+0.444; fIEPOXOO(i)=fIEPOXOO(i)+0.112; fMGLY(i)=fMGLY(i)+0.444;
% --------------ICTP-----------------
% based on C536OOH and C537OOH in MCM. OH oxidation product (C4carbonyldiperoxide) lumped to
% condensable hydroperoxide.
i=i+1;
Rnames{i} = 'ICTP + OH = RAOOH + CO + OH';
k(:,i) = 6E-11 ;
Gstr{i,1} = 'ICTP'; Gstr{i,2} = 'OH'; 
fICTP(i)=fICTP(i)-1; fRAOOH(i)=fRAOOH(i)+1; fCO(i)=fCO(i)+1; 

i=i+1;
Rnames{i} = 'ICTP = R6OOH + 2OH + 0.33HCHO + 0.67GLY';
k(:,i) = 3*JCOOH ;
% k(:,i) = 0.02.*JNO2_06; % added by chuanyang
Gstr{i,1} = 'ICTP';
fICTP(i)=fICTP(i)-1; fR6OOH(i)=fR6OOH(i)+1; fOH(i)=fOH(i)+2; fHCHO(i)=fHCHO(i)+0.33; fGLY(i)=fGLY(i)+0.67; 
% --------------ITHN-----------------
...
% --------------IDHCN-----------------
i=i+1;
Rnames{i} = 'IDHCN = 0.5HO2 + NO2 + 0.375CO + 0.375C4DH + 0.5MECO3 + 0.53HACET + 0.094HOCCHO + 0.094MGLY + 0.031GLY';
...
% --------------IDHPN-----------------
i=i+1;
Rnames{i} = 'IDHPN = 0.65OH + 0.7HO2 + 0.35HCHO + 0.25MACRN + 0.325HOCCHO + 0.625HACET + 0.725NO2 + 0.075MECO3 + 0.025MVKN + 0.25HPETHNL + 0.075MACROOHOH + 0.025HPAC';
...
% --------------ICHNP-----------------
i=i+1;
Rnames{i} = 'ICHNP = 0.8MGLY + 0.8OH + NO2 + 0.8HOCCHO + 0.1MVKOOHOH + 0.1MACROOHOH + 0.2CO + 0.2HO2';
...
i=i+1;
Rnames{i} = 'ICHNP + OH = CO + NO2 + 0.75MVKOOHOH + 0.25MACROOHOH';
k(:,i) = 1.0E-11 ;
Gstr{i,1} = 'ICHNP'; Gstr{i,2} = 'OH'; 
fICHNP(i)=fICHNP(i)-1; fOH(i)=fOH(i)-1; fCO(i)=fCO(i)+1; fNO2(i)=fNO2(i)+1; fMVKOOHOH(i)=fMVKOOHOH(i)+1; fMACROOHOH(i)=fMACROOHOH(i)+1; 
% --------------ICHDN-----------------
i=i+1;
Rnames{i} = 'ICHDN = 1.713NO2 + 0.525CO + 0.1C4DH + 0.138MVKN + 0.138MACRN + 0.338HO2 + 0.013GLY + 0.013RNO3I + 0.025MGLY + 0.463MECO3 + 0.563HACET + 0.188HCHO';
...
i=i+1;
Rnames{i} = 'ICHDN + OH = CO + NO2 + 0.5MACRN + 0.5MVKN';
k(:,i) = 1.0E-11*0.4 ;
...
% --------------IDHDN-----------------
i=i+1;
Rnames{i} = 'IDHDN = 2NO2 + HOCCHO + HACET';
...
% --------------IHNE-----------------
i=i+1;
Rnames{i} = 'IHNE + OH = 0.16ICHNP + 0.04PROPNN + 0.04CO + 0.04HO2 + 0.04HCHO + 0.04OH + 0.2RO2C + 0.2ISOPNOO + 0.6ICNE';
...
% --------------IHPDN-----------------
i=i+1;
Rnames{i} = 'IHPDN + OH = 0.875IHDNOO + 0.125OH + 0.125ICHDN';
k(:,i) = 1.0E-12 ;
Gstr{i,1} = 'IHPDN'; Gstr{i,2} = 'OH'; 
fIHPDN(i)=fIHPDN(i)-1; fOH(i)=fOH(i)-0.875; fIHDNOO(i)=fIHDNOO(i)+1; fICHDN(i)=fICHDN(i)+1; 

i=i+1;
Rnames{i} = 'IHPDN = 0.884OH + 0.533HO2 + 0.49NO2 + 0.678PROPNN + 0.28HOCCHO + 0.135ICHDN + 0.375ETHLN + 0.094ISOPNOO + 0.094MVKN + 0.094HCHO + 0.023HPETHNL';
...
% --------------MVKOOHOH-----------------
i=i+1;
Rnames{i} = 'MVKOOHOH = 0.8MECO3 + 0.8HOCCHO + OH + 0.2HO2 + 0.2HCHO + 0.2MGLY';
k(:,i) = JMEK_06 + JCOOH; %J22 + J41 ;
Gstr{i,1} = 'MVKOOHOH'; 
fMVKOOHOH(i)=fMVKOOHOH(i)-1; fMECO3(i)=fMECO3(i)+0.8; fHOCCHO(i)=fHOCCHO(i)+0.8; fOH(i)=fOH(i)+1;fHO2(i)=fHO2(i)+0.2; fHCHO(i)=fHCHO(i)+0.2; fMGLY(i)=fMGLY(i)+0.2;
i=i+1;
Rnames{i} = 'MVKOOHOH + OH = HC4 + OH';
k(:,i) = 5.77E-11 ;
Gstr{i,1} = 'MVKOOHOH'; Gstr{i,2} = 'OH'; 
fMVKOOHOH(i)=fMVKOOHOH(i)-1; fHC4(i)=fHC4(i)+1;
% --------------MVKN-----------------

% %IS84 and IS106. updated with the rxns below.
% i=i+1;
% Rnames{i} =' MVKN + OH = 0.65*HCOOH + 0.65*MGLY + 0.35*HCHO + 0.35*PYRUACD + NO3';
% k(:,i) = 3.5e-12.*exp(140./ T);
% Gstr{i,1} = 'MVKN'; Gstr{i,2} = 'OH'; 
% fMVKN(i)=fMVKN(i)-1;fOH(i)=fOH(i)-1;fHCHO(i)=fHCHO(i)+0.35;fHCOOH(i)=fHCOOH(i)+0.65;
...
% fMECO3(i)=fMECO3(i)+1;
i=i+1;
Rnames{i} = 'MVKN = 1.23MECO3 + 0.77HOCCHO + NO2 + 0.23HO2';
...
i=i+1;
Rnames{i} = 'MVKN + OH = 0.585HCOOH + 0.9NO3 + 0.585MGLY + 0.315HCHO + 0.315PYRUACD + 0.1HC4 + 0.1NO2';
k(:,i) = 1.16E-12*exp(380./T) + 5.13E-13;
Gstr{i,1} = 'MVKN'; Gstr{i,2} = 'OH'; 
fMVKN(i)=fMVKN(i)-1; fOH(i)=fOH(i)-1; 
fHCOOH(i)=fHCOOH(i)+0.585; fNO3(i)=fNO3(i)+0.9; fMGLY(i)=fMGLY(i)+0.585; fHCHO(i)=fHCHO(i)+0.315; fPYRUACD(i)=fPYRUACD(i)+0.315; fHC4(i)=fHC4(i)+0.1;fNO2(i)=fNO2(i)+0.1;
...
i=i+1;
Rnames{i} = 'IMPAA = OH + 1.65CO2 + 0.65MEO2 + HCHO + 0.35MECO3';
k(:,i) = JMEK_06 + JCOOH; %J22+J41 ;
Gstr{i,1} = 'IMPAA'; 
fIMPAA(i)=fIMPAA(i)-1; fOH(i)=fOH(i)+1; fMEO2(i)=fMEO2(i)+0.65; fHCHO(i)=fHCHO(i)+1; fMECO3(i)=fMECO3(i)+0.35;
i=i+1;
Rnames{i} = 'IMPAA + OH = 0.73IHMML + 0.27IMAE + OH  ';
k(:,i) = 1.9e-11.*exp(390./T);
Gstr{i,1} = 'IMPAA'; Gstr{i,2} = 'OH';
fIMPAA(i)=fIMPAA(i)-1;fIHMML(i)=fIHMML(i)+0.73;fIMAE(i)=fIMAE(i)+0.27;
% --------------MACROOHOH-----------------
i=i+1;
Rnames{i} = 'MACROOHOH = OH + HO2 + 0.9CO + 0.9HACET + 0.1HCHO + 0.1MGLY';
k(:,i) = JMEK_06 + JCOOH; %J22+J41 ;
Gstr{i,1} = 'MACROOHOH';  
fMACROOHOH(i)=fMACROOHOH(i)-1; fOH(i)=fOH(i)+1; fHO2(i)=fHO2(i)+1; fCO(i)=fCO(i)+0.9; fHACET(i)=fHACET(i)+0.9; fHCHO(i)=fHCHO(i)+0.1; fMGLY(i)=fMGLY(i)+0.1; 
i=i+1;
Rnames{i} = 'MACROOHOH + OH = OH + 0.9CO + 0.9HACET + 0.1CO2 + 0.1HPAC';
k(:,i) = 2.7E-12*exp(470./T); 
Gstr{i,1} = 'MACROOHOH'; Gstr{i,2} = 'OH'; 
fMACROOHOH(i)=fMACROOHOH(i)-1; fCO(i)=fCO(i)+0.9; fHACET(i)=fHACET(i)+0.9; fHPAC(i)=fHPAC(i)+0.1; 
% --------------IMAPAN-----------------
...
i=i+1;
Rnames{i} = ' IMAPAN + OH = 0.72HMML + 0.03IMAE + NO3 + 0.25HACET + 0.25CO';
k(:,i) = 3.0e-11;
Gstr{i,1} = 'IMAPAN'; Gstr{i,2} = 'OH';
...
i=i+1;
Rnames{i} = ' IMAE + OH = HCOOH + RO2C';
k(:,i) = 1.0e-12;
Gstr{i,1} = 'IMAE'; Gstr{i,2} = 'OH';
fIMAE(i)=fIMAE(i)-1;fOH(i)=fOH(i)-1;fHCOOH(i)=fHCOOH(i)+1;fRO2C(i)=fRO2C(i)+1;
...
i=i+1;
Rnames{i} = 'IHMML + OH = 0.7MGLY + 0.7OH + 0.3MECO3 + 0.3HCOOH';
k(:,i) = 4.33E-12 ;
Gstr{i,1} = 'IHMML'; Gstr{i,2} = 'OH'; 
fIHMML(i)=fIHMML(i)-1; fOH(i)=fOH(i)-0.3; fMGLY(i)=fMGLY(i)+0.7; fMECO3(i)=fMECO3(i)+0.3; fHCOOH(i)=fHCOOH(i)+0.3;
...
k(:,i) = 1E-16 .*H2O;
% k(:,i) = 1e-17 .*H2O; % added by chuanyang
Gstr{i,1} = 'IHMML';
...
% i=i+1;
% Rnames{i} =' MACRN + OH = 0.08*CCOOH + 0.08*HCHO + 0.08*NO3 + 0.07*HCOOH + 0.07*NO3 + 0.07*MGLY + 0.85*HACET + 0.85*NO2 + 0.93*CO2';
...
% fMGLY(i)=fMGLY(i)+0.07;fNO3(i)=fNO3(i)+0.08;fNO3(i)=fNO3(i)+0.07;fHCOOH(i)=fHCOOH(i)+0.07;
...
i=i+1;
Rnames{i} = 'MACRN + OH = 0.08*CCOOH + 0.08*HCHO + 0.07*HCOOH + 0.07*MGLY + 0.85*HACET + 0.85*NO2 + 0.15*NO3';
k(:,i) = 1.39E-11*exp(380/T);
Gstr{i,1} = 'MACRN'; Gstr{i,2} = 'OH'; 
fMACRN(i)=fMACRN(i)-1; fOH(i)=fOH(i)-1; fCCOOH(i)=fCCOOH(i)+0.08;fHCOOH(i)=fHCOOH(i)+0.07;fHCHO(i)=fHCHO(i)+0.08;
fNO2(i)=fNO2(i)+0.85;fMGLY(i)=fMGLY(i)+0.07;fHACET(i)=fHACET(i)+0.85;fNO3(i)=fNO3(i)+0.15;

%% Lumped C4 products
% --------------C4ENOL-----------------
i=i+1;
Rnames{i} = 'C4ENOL = 0.95CO + 0.9PYRUACD + 1.9OH + 0.1MGLY + 0.05HO2 + 0.05MECO3 + 0.05GLY';
...
i=i+1;
Rnames{i} = 'C4ENOL + OH = 0.192OH + 0.808HO2 + 0.9CO + 0.783PYRUACD + 0.117CO2 + 0.117MECO3 + 0.025HC4 + 0.075MGLY + 0.075HCOOH';
k(:,i) = 3.78E-12*exp(983./T); 
Gstr{i,1} = 'C4ENOL'; Gstr{i,2} = 'OH'; 
fC4ENOL(i)=fC4ENOL(i)-1; fOH(i)=fOH(i)-0.808; 
fHO2(i)=fHO2(i)+0.808; fHC4(i)=fHC4(i)+0.025; fMGLY(i)=fMGLY(i)+0.075; fHCOOH(i)=fHCOOH(i)+0.075;
fCO(i)=fCO(i)+0.9; fPYRUACD(i)=fPYRUACD(i)+0.783; fMECO3(i)=fMECO3(i)+0.117;
% --------------C4DH-----------------
i=i+1;
Rnames{i} = 'C4DH + OH = 0.6HC4 + 0.31OH + HO2 + 0.4CO + 0.1HACET + 0.3MECO3';
k(:,i) = 1.25E-11*exp(70./T);
Gstr{i,1} = 'C4DH'; Gstr{i,2} = 'OH';
fC4DH(i)=fC4DH(i)-1; fOH(i)=fOH(i)-0.69;
fHC4(i)=fHC4(i)+0.6; fHO2(i)=fHO2(i)+1;fCO(i)=fCO(i)+0.4; fHACET(i)=fHACET(i)+0.1; fMECO3(i)=fMECO3(i)+0.3;
% --------------HC4-----------------
i=i+1;
Rnames{i} = 'HC4 = 0.825CO + 1.175HO2 + 0.65HCHO + 0.825MECO3 + 0.175GLY + 0.175MGLY';
k(:,i) = 2.*JACET_06; %J35 ; 
Gstr{i,1} = 'HC4'; 
fHC4(i)=fHC4(i)-1; fCO(i)=fCO(i)+0.825; fHO2(i)=fHO2(i)+1.175; fHCHO(i)=fHCHO(i)+0.65; fMECO3(i)=fMECO3(i)+0.825;fGLY(i)=fGLY(i)+0.175;fMGLY(i)=fMGLY(i)+0.175; 
i=i+1;
Rnames{i} = 'HC4 + OH = 0.5CO + 0.35HO2 + 0.85OH + 0.35MECO3 + 0.65MGLY + 0.85CO2';
k(:,i) = 2.3E-12*exp(470./T); 
Gstr{i,1} = 'HC4'; Gstr{i,2} = 'OH'; 
fHC4(i)=fHC4(i)-1; fOH(i)=fOH(i)-0.15; fCO(i)=fCO(i)+0.5; fHO2(i)=fHO2(i)+0.35; fMECO3(i)=fMECO3(i)+0.35; fMGLY(i)=fMGLY(i)+0.65;
% --------------C4PN-----------------
i=i+1;
Rnames{i} = 'C4PN = OH + 0.5HO2 + 0.5MECO3 + 0.5ETHLN + 0.5PROPNN + 0.5CO';
...
i=i+1;
Rnames{i} = 'C4PN + OH = OH + 0.2CO + 0.2PROPNN + 1.6MECO3 + 0.8NO2';
k(:,i) = 3.32E-11 ;
...
%IS79. Unchanged.
i=i+1;
Rnames{i} =' HOCCHO + OH = 0.75*HO2 + 0.25*OH + 0.13*GLY + 0.52*CO + 0.35*CO2 + 0.16*HCOOH + 0.71*HCHO';
k(:,i) = 0.8e-11;
Gstr{i,1} = 'HOCCHO'; Gstr{i,2} = 'OH'; 
fHOCCHO(i)=fHOCCHO(i)-1; fOH(i)=fOH(i)-1;fHO2(i)=fHO2(i)+0.75;fOH(i)=fOH(i)+0.25;
fCO2(i)=fCO2(i)+0.35;fGLY(i)=fGLY(i)+0.13;fHCHO(i)=fHCHO(i)+0.71;fHCOOH(i)=fHCOOH(i)+0.16;
fCO(i)=fCO(i)+0.52;
...
%IS80. Unchanged.
i=i+1;
Rnames{i} =' HACET + OH = 0.75*MGLY + 0.825*HO2 + 0.125*HCOOH + 0.1*OH + 0.125*MEO2 + 0.20*CO2 + 0.05*CO + 0.125*CCOOH';
k(:,i) = 2.15e-12.*exp(305./ T);
Gstr{i,1} = 'HACET'; Gstr{i,2} = 'OH'; 
fHACET(i)=fHACET(i)-1; fOH(i)=fOH(i)-1;fHO2(i)=fHO2(i)+0.825;fOH(i)=fOH(i)+0.1;
fCO2(i)=fCO2(i)+0.2;fMGLY(i)=fMGLY(i)+0.75;fMEO2(i)=fMEO2(i)+0.125;fHCOOH(i)=fHCOOH(i)+0.125;
...
%% HPETHNL rxns
i=i+1;
Rnames{i} = 'HPETHNL + OH = 0.85GLY + 0.15CO + 0.15HCHO + OH ';
k(:,i) = 3.42E-11 ;
...
% i=i+1;
% Rnames{i} = 'IMAE = IEPOXSOA';
% k(:,1)= F0AM_isop_Khet(T,Rp,Sa,V, lorg);
% Gstr{i,1}='IMAE';
% fIMAE(i)=fIMAE(i)-1; fIEPOXSOA(i)= fIEPOXSOA(i)+1;
