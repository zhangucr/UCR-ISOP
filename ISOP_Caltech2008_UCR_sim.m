function[S]=ISOP_Caltech2008_UCR_sim(test_dat,Do_GP)
...
%     'Rp'        Rp*10^-4;  %cm
    ...
    'EF_NO'     0  ;...  
    'JNO2_06'   0;... %was 0.29/60     %jvalue in Kroll seems too high (based on O3 production) Kroll 2006 %Override calcuated J-value for NO2 + hv -->
    'JHNO4_06'  0;
    'JPAN'      0;
    'JBALD_06'  0;
    'JCL2'      0;
