...
id=1:1:8;
for expt=1:8
    [S1]=ISOP_Caltech2008_UCR_sim(test_dat(expt,:),0);
    [S2]=ISOP_Caltech2008_Caltech_sim(test_dat(expt,:),0);
    [S3]=ISOP_Caltech2008_MCM_sim(test_dat(expt,:),0);
    [S4]=ISOP_Caltech2008_UW_sim(test_dat(expt,:),0);
end
figname=['figures/Gas_Caltech2008Expt',num2str(expt),'.jpg'];
%%
close all;
